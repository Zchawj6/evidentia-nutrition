---
title: "Curcumin (Standard Extract)"
slug: "curcumin"
category: "botanical"
tags: ["curcumin", "turmeric", "polyphenol", "botanical", "anti-inflammatory", "curcuminoids", "bioavailability"]
aliases: ["turmeric extract", "curcuminoids", "diferuloylmethane"]
primaryRating: "Insufficient"
primaryOutcome: "Anti-inflammatory, joint, cognitive, and metabolic outcomes using standard curcumin extract in humans"
outcomeType: "clinical"
numberOfRCTs: 22
totalParticipantN: 1400
riskOfBiasSummary: "Small sample sizes, short durations, highly variable formulations, and poor bioavailability of the standard extract undermine most trials; results are not generalisable across formulations"
consistencyFlag: "Inconsistent"
surrogateOnly: false
formSpecificEvidence: true
formStudied: "Standard curcumin extract (95% curcuminoids) -- evidence from enhanced-bioavailability forms such as curcumin phytosome is not transferable to this entry"
additionalOutcomes:
  - outcome: "Inflammatory biomarker effects (CRP, IL-6, TNF-alpha)"
    ...
    riskOfBiasSummary: "Mixed results highly dependent on formulation; effects in well-controlled trials with standard extract are small and inconsistent; not validated as clinical surrogates for curcumin specifically"
    consistencyFlag: "Inconsistent"
  - outcome: "Joint pain and function in osteoarthritis"
    rating: "Insufficient"
    outcomeType: "clinical"
    numberOfRCTs: 8
    totalParticipantN: 500
    riskOfBiasSummary: "Positive signals largely from trials using enhanced-bioavailability formulations, not standard extract; standard extract trials are mixed and underpowered"
    consistencyFlag: "Inconsistent"
  - outcome: "Cognitive function and mood"
    rating: "Insufficient"
    outcomeType: "clinical"
    numberOfRCTs: 5
    totalParticipantN: 280
    riskOfBiasSummary: "Very limited evidence with standard extract; positive signals almost entirely from enhanced formulations; standard extract does not achieve plasma concentrations relevant to CNS activity"
    consistencyFlag: "Inconsistent"
  - outcome: "Metabolic and glycaemic outcomes in type 2 diabetes and metabolic syndrome"
    ...
    riskOfBiasSummary: "Small trials with variable formulations; modest effects on fasting glucose and insulin sensitivity reported but not robustly replicated with standard extract specifically"
...
populationNotes: "No population has been identified in which standard curcumin extract produces consistent and clinically meaningful benefit. The fundamental barrier is bioavailability, not the underlying compound -- the evidence for enhanced-bioavailability forms is a separate question covered in the curcumin phytosome entry."
safetyFlag: true
safetyNotes: "Standard curcumin extract is generally well-tolerated at doses up to 8g/day in short-term studies. GI discomfort is the most commonly reported side effect. At high doses, reversible elevations in liver enzymes have been reported in isolated cases. Curcumin has antiplatelet and anticoagulant properties -- relevant for individuals on warfarin, aspirin, or other anticoagulants. May inhibit CYP3A4 and affect drug metabolism. Iron absorption may be reduced with high-dose supplementation. Use with caution in individuals with gallbladder disease as curcumin stimulates bile production."
...
relatedEntries: ["curcumin-phytosome", "resveratrol"]
cardDescription: "The gap between turmeric's reputation and the evidence for standard curcumin extract is almost entirely a bioavailability problem. The compound shows biological activity in the lab but does not reach meaningful concentrations in the body from conventional supplements."
---
...
Meta-analyses pooling heterogeneous curcumin trials report reductions in CRP, IL-6, and TNF-alpha. These pooled results are driven substantially by trials using enhanced formulations. When standard extract trials are isolated, effects are small, inconsistent, and not reliably distinguishable from placebo. CRP is a non-specific marker responsive to many interventions and is not a validated surrogate for clinical outcomes in the context of curcumin specifically.

Sahebkar et al. (2015) conducted a meta-analysis across 34 RCTs showing significant effects, but formulation heterogeneity was substantial and standard extract trials were not isolated in the analysis. Hewlings and Kalman (2017) reviewed the broader evidence and correctly noted the formulation dependency of outcomes.

**Evidence rating basis:** Insufficient for standard extract. Effects in well-controlled standard extract trials are small and inconsistent. Pooled meta-analytic results are not applicable to this form.
...
The curcumin evidence base includes a mix of industry-funded and independently funded trials. Trials using proprietary enhanced formulations are often funded by the respective patent holders, creating a structural positive bias in those formulation-specific trials. Standard extract trials have more mixed funding but are generally smaller and lower quality.
...
- Liu W et al. Curcumin vs. NSAIDs for the treatment of osteoarthritis: a systematic review of randomized controlled trials. J Orthop Surg Res. 2021;16(1):498.
...
- Prasad S et al. Recent developments in delivery, bioavailability, absorption and metabolism of curcumin. Cancer Res Treat. 2014;46(1):2-18.
