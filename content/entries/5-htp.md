...
tags: ["5-htp", "serotonin", "depression", "anxiety", "sleep", "mood", "weight", "fibromyalgia"]
aliases: ["5-hydroxytryptophan", "oxitriptan"]
primaryRating: "Emerging"
primaryOutcome: "Depressive symptoms in clinical populations"
outcomeType: "clinical"
numberOfRCTs: 6
totalParticipantN: 350
riskOfBiasSummary: "Small trials, older methodology, short durations, variable comparators; most trials have significant limitations"
consistencyFlag: "Mixed"
surrogateOnly: false
formSpecificEvidence: false
formStudied: "Oral 5-hydroxytryptophan"
additionalOutcomes:
  - outcome: "Sleep quality"
    rating: "Insufficient"
    outcomeType: "clinical"
    numberOfRCTs: 3
    totalParticipantN: 120
    riskOfBiasSummary: "Very small trials, heterogeneous populations, some in neurological conditions only"
    consistencyFlag: "Mixed"
  - outcome: "Anxiety symptoms"
    rating: "Insufficient"
    outcomeType: "clinical"
    numberOfRCTs: 3
    totalParticipantN: 110
    riskOfBiasSummary: "Very small trials, mostly older, methodological limitations throughout"
    consistencyFlag: "Mixed"
  - outcome: "Appetite and weight"
    rating: "Emerging"
    outcomeType: "clinical"
    numberOfRCTs: 4
    totalParticipantN: 180
    riskOfBiasSummary: "Small trials, short duration, mostly in overweight populations; modest effects"
    consistencyFlag: "Mixed"
  - outcome: "Fibromyalgia symptoms"
    rating: "Emerging"
    outcomeType: "clinical"
    numberOfRCTs: 3
    totalParticipantN: 150
    riskOfBiasSummary: "Small older trials, limited replication"
    consistencyFlag: "Mixed"
individualisationRelevance: "High"
bloodTestingRelevant: false
geneticVariationRelevant: true
populationSpecific: true
populationNotes: "Evidence primarily in clinical populations with depression, fibromyalgia, or overweight. Healthy individuals with no relevant symptoms have very limited supporting evidence. Genetic variation in serotonin metabolism (including TPH1, SERT polymorphisms) may influence response but is not clinically actionable at present."
safetyFlag: true
safetyNotes: "Serotonin syndrome risk when combined with serotonergic medications including SSRIs, SNRIs, MAOIs, tramadol, and triptans -- this is a serious and potentially life-threatening interaction. Do not combine without medical supervision. Eosinophilia-myalgia syndrome has been historically associated with contaminated tryptophan supplements; the direct risk from 5-HTP itself is uncertain but cannot be fully excluded. Gastrointestinal adverse effects are common at higher doses. Long-term safety is not established. Not recommended in pregnancy."
...
relatedEntries: ["magnesium", "l-theanine", "ashwagandha"]
cardDescription: "A serotonin precursor with a plausible mechanism and a genuinely limited evidence base. The safety considerations around drug interactions are more firmly established than the clinical benefits."
---
...
The clinical trial history for 5-HTP in depression extends back to the 1970s, making it longer-standing than much of the supplement evidence base. However, the quality and volume of that evidence has not kept pace with its duration.

The Cochrane systematic review by Shaw, Turner, and Del Mar (2002) identified 108 trials of 5-HTP or tryptophan for depression but found only two that met minimum quality criteria for inclusion: both were small, both showed benefit over placebo, and both had significant methodological limitations including inadequate allocation concealment and short follow-up. The reviewers concluded the evidence was insufficient to draw firm conclusions. This review has not been superseded by substantially better evidence. That a compound with approximately 50 years of clinical investigation has not generated a single large, well-powered, independently conducted modern RCT is itself informative -- it suggests limited commercial or clinical research investment in establishing this indication definitively.

A frequently cited line of research involves comparison of 5-HTP to antidepressant medications. Van Praag and colleagues conducted several such comparisons in the 1970s and 1980s, and some trials reported comparable effects. A trial by Angst and colleagues (1977) compared 5-HTP to imipramine in 30 patients and found similar response rates. These studies are of historical interest but are too small, too old, and too methodologically limited to inform current clinical decisions. They were conducted before modern diagnostic criteria, blinding standards, and outcome measurement tools were established.

More recent work has been sparse. A 2013 open-label pilot study by Jacobsen and colleagues examined 5-HTP augmentation of SSRI treatment, but open-label designs cannot support efficacy conclusions. The absence of a well-powered modern placebo-controlled trial is the central gap in this literature.

**Evidence rating basis:** Emerging. Plausible mechanism, historical trial signals, Cochrane review confirming insufficient quality evidence for firm conclusions, no large modern replication.

### Sleep

The sleep evidence is thinner than for depression. A small number of trials have examined 5-HTP effects on sleep architecture, partly on the rationale that serotonin is a precursor to melatonin as well as a neurotransmitter in its own right.

Trials in children with sleep terrors (Bruni et al., 2004) showed some benefit, but this is a specific paediatric neurological indication not generalisable to adult sleep supplementation. A trial using a combination of 5-HTP, GABA, and valerian showed improvements in sleep latency and quality in adults, but combination designs preclude attribution to 5-HTP specifically.

In healthy adults without sleep disorders, isolated evidence is absent. The mechanism -- serotonin as a melatonin precursor -- is biologically reasonable but does not establish that oral 5-HTP reliably improves sleep in this population.

**Evidence rating basis:** Insufficient. Mechanistic rationale present, trial evidence restricted to specific populations or combination formulas, no adequate isolated evidence in healthy adults.

### Appetite and weight

Four small trials have examined 5-HTP effects on appetite and caloric intake, primarily in overweight or obese individuals. Cangiano and colleagues (1992, 1998) conducted the most frequently cited work, finding that 5-HTP supplementation at 300mg three times daily reduced carbohydrate intake and body weight compared to placebo over 6 and 12 weeks respectively in overweight women. The proposed mechanism involves serotonin-mediated early satiety signalling.

The Cangiano trials are often used as primary evidence for appetite effects, but they are small (25 to 30 participants each), conducted by the same group without independent replication, and used doses substantially higher than typical supplement doses. A more recent trial by Ioannou and colleagues (2021) found modest effects on appetite ratings but not on objective caloric intake in a crossover design.

**Evidence rating basis:** Emerging. Mechanistically plausible, modest signals in small trials, concentrated in overweight populations, no large independent replication.

### Fibromyalgia

Three small randomised controlled trials have examined 5-HTP in fibromyalgia, a condition characterised by widespread musculoskeletal pain, fatigue, and sleep disturbance, and one in which serotonergic pathways have been implicated. The trials by Caruso and colleagues (1990) and Puttini and Caruso (1992) found improvements in pain, morning stiffness, sleep quality, and fatigue compared to placebo over 30 to 90 days at doses of 100mg three times daily.

This is one of the more internally consistent signals in the 5-HTP literature, and the indication has biological plausibility given the serotonergic component of fibromyalgia pathophysiology. However, the trials are old, small, and from a limited number of research groups. Independent replication in modern trial designs has not been conducted.

**Evidence rating basis:** Emerging. Consistent signal across a small number of older trials in a specific clinical population. Insufficient for a clinical recommendation in the absence of modern replication.

### Anxiety

Preliminary evidence from small trials suggests 5-HTP may reduce anxiety symptoms. Kahn and colleagues (1987) compared 5-HTP to clomipramine and placebo in panic disorder and found some anxiolytic signal, but the trial was small and methodology was limited. A study by Schruers and colleagues (2002) found 5-HTP reduced panic response to carbon dioxide challenge in panic disorder patients.

These are mechanistically interesting findings but are not sufficient to support a clinical anxiety indication. The evidence does not extend meaningfully to generalised anxiety, social anxiety, or anxiety in healthy individuals.

**Evidence rating basis:** Insufficient. Preliminary signals in specific anxiety disorder populations, inadequate for broader conclusions.
...
- Caruso I et al. Double-blind study of 5-hydroxytryptophan versus placebo in the treatment of primary fibromyalgia syndrome. J Int Med Res. 1990;18(3):201-209.
...
- Bruni O et al. L-5-Hydroxytryptophan treatment of sleep terrors in children. Eur J Pediatr. 2004;163(7):402-407.
- Kahn RS et al. Effect of a serotonin precursor and uptake inhibitor in anxiety disorders; a double-blind comparison of 5-hydroxytryptophan, clomipramine and placebo. Int Clin Psychopharmacol. 1987;2(1):33-45.
- Schruers K et al. Acute L-5-hydroxytryptophan administration inhibits carbon dioxide-induced panic in panic disorder patients. Psychiatry Res. 2002;113(3):237-243.
- Jacobsen JP et al. Augmentation of serotonin release by 5-hydroxytryptophan. Neuropharmacology. 2016;103:136-148.
