...
## Strain-specificity and disease-specificity: the evidence base

The principle that probiotic efficacy is strain-specific and disease-specific has been formally examined in the literature. McFarland et al. (2018) conducted a systematic review and meta-analysis across 12 meta-analyses covering multiple probiotic strains and conditions, finding that strain-specific effects were demonstrable and that pooling results across different strains introduced significant heterogeneity. This finding has been replicated in disease-specific analyses, including a focused analysis of IBS (McFarland et al., EClinicalMedicine, 2021) that found strain-specific and outcome-specific variation in efficacy within a single condition.

This evidence has direct implications for how product labels should be interpreted and how consumer recommendations should be framed. A product containing "Lactobacillus rhamnosus" without further strain specification cannot be assumed to behave like LGG (Lactobacillus rhamnosus GG), which is itself designated by the GG strain identifier. The GG designation refers to the specific isolate studied in the original foundational trials; other L. rhamnosus preparations may have entirely different properties.

## Gut microbiota diversity: what supplementation does and does not achieve

A 2026 systematic review and meta-analysis in BMC Medicine examining 47 studies found no significant effect of probiotic supplementation on alpha-diversity in healthy populations. This finding requires careful interpretation. Alpha-diversity is a measure of within-sample species richness and evenness; its absence of change does not preclude functional changes in microbiota metabolic activity, species composition at other taxonomic levels, or other aspects of gut ecology not captured by standard diversity indices. What the finding does address specifically is the claim that probiotic supplementation meaningfully increases gut microbiota diversity in healthy individuals, for this, the evidence is not supportive. Diversity effects have been observed in clinical populations with established dysbiosis, which is a meaningfully different context from healthy supplementation.

A separate umbrella meta-analysis (European Journal of Medical Research, 2025) covering gastrointestinal disorder populations found consistent positive effects on specific clinical outcomes including diarrhoea duration and certain IBS symptom clusters. The contrast between these two findings, meaningful clinical effects in symptomatic populations, no clear diversity effect in healthy populations, reflects a pattern seen across the probiotic literature: interventions with real clinical utility in disease states do not necessarily confer equivalent benefits in health.

## Evidence profiles by strain: overview

The five strains covered in this library represent different points on the evidence spectrum. LGG has the most extensive trial evidence base of any single probiotic strain and is the benchmark against which others are often compared in meta-analyses. S. boulardii has a distinct and clinically relevant property set by virtue of being a yeast. L. reuteri has an unusually broad range of studied applications, though the evidence quality varies substantially across them. L. acidophilus has a large commercial footprint but limited and inconsistent trial evidence relative to its ubiquity. BB-12 has a reasonable and relatively well-characterised evidence base, particularly in digestive and immune contexts.

Full evidence ratings, outcome-by-outcome assessments, trial details, and interpretation guidance are provided in the individual strain entries. The hub page is intended to contextualise those findings and provide the conceptual framework for reading probiotic evidence accurately.

## Key references

McFarland LV, Evans CT, Goldstein EJC. Strain-specificity and disease-specificity of probiotic efficacy: a systematic review and meta-analysis. Frontiers in Medicine. 2018;5:124.
...
Wang Q, Ren T, Wang H, Lin X. The effect of probiotics on the diarrhea and constipation outcomes in children: an umbrella review of systematic reviews and meta-analyses. Frontiers in Nutrition. 2025;12:1606264.

Liang T et al. Probiotics and gastrointestinal disorders: an umbrella meta-analysis of therapeutic efficacy. European Journal of Medical Research. 2025;30:515.

Wieers G et al. Effect of probiotic supplementation on the gut microbiota diversity in healthy populations: a systematic review and meta-analysis of randomised controlled trials. BMC Medicine. 2026.

Hill C, Guarner F, Reid G, et al. The International Scientific Association for Probiotics and Prebiotics consensus statement on the scope and appropriate use of the term probiotic. Nature Reviews Gastroenterology and Hepatology. 2014;11:506-514.