...
tags: ["citicoline", "cdp-choline", "choline", "cognition", "memory", "neuroprotection", "stroke"]
aliases: ["CDP-choline", "cytidine diphosphate choline", "Cognizin"]
primaryRating: "Moderate"
primaryOutcome: "Cognitive function in older adults and individuals with mild cognitive impairment"
outcomeType: "clinical"
numberOfRCTs: 18
totalParticipantN: 2200
riskOfBiasSummary: "Variable; many trials are older (1990s-2000s) with heterogeneous outcome measures and variable quality; positioned at the lower end of Moderate due to trial age and limited modern replication; largest stroke trial (ICTUS) was null; some industry involvement in healthy adult trials"
...
additionalOutcomes:
  - outcome: "Cognitive support in healthy adults under cognitive demand"
    ...
    riskOfBiasSummary: "Small trials; some industry funding; effect sizes small and task-dependent; limited independent replication"
    consistencyFlag: "Mixed"
  - outcome: "Stroke recovery and vascular cognitive impairment"
    rating: "Moderate"
    outcomeType: "clinical"
    numberOfRCTs: 8
    totalParticipantN: 1200
    riskOfBiasSummary: "ICTUS (n=2298) null on primary endpoint; no subsequent large trial has overturned this; earlier positive trials smaller and heterogeneous; confidence materially reduced"
    consistencyFlag: "Inconsistent"
  - outcome: "General cognitive enhancement in healthy replete adults"
    rating: "Insufficient"
    outcomeType: "clinical"
    numberOfRCTs: 4
    totalParticipantN: 300
    riskOfBiasSummary: "Small trials; inconsistent outcomes; no evidence of benefit in genuinely replete individuals"
    consistencyFlag: "Inconsistent"
individualisationRelevance: "High"
bloodTestingRelevant: false
geneticVariationRelevant: true
populationSpecific: true
populationNotes: "Evidence strongest in older adults with age-associated memory impairment or mild cognitive impairment. Dietary choline adequacy is a relevant background consideration though its relationship to cognitive outcomes is not clearly established. Evidence for healthy adults without cognitive concerns is limited."
safetyFlag: true
safetyNotes: "Generally well-tolerated at doses of 250-500mg/day. GI effects at higher doses. Headache reported in some individuals. Theoretical TMAO concern from choline metabolism -- clinical significance at supplemental doses not established. Not well-studied in pregnancy at supplemental doses."
...
relatedEntries: ["vitamin-b12", "magnesium"]
cardDescription: "Meaningful evidence for cognitive support in older adults and clinical populations. Distinct from other choline forms. Claims for general cognitive enhancement in healthy adults outrun the evidence."
---
...
The mechanistic basis is plausible: citicoline supports phosphatidylcholine synthesis, provides choline for acetylcholine synthesis, and supplies uridine for membrane repair. These mechanisms are plausible rather than proven drivers of clinical benefit and should not carry interpretive weight beyond the clinical outcome data.
...
Earlier trials and meta-analyses showed positive effects on cognitive and functional outcomes in stroke recovery. The ICTUS trial (Dávalos et al., 2012; n = 2298) was the definitive test of this hypothesis. It found no significant benefit on the primary global outcome measure in acute ischaemic stroke. This is the largest and most robustly designed citicoline trial ever conducted, and no subsequent large trial has overturned this null finding.

The divergence between earlier positive findings and the ICTUS null result has not been resolved. Some residual signal remains for specific cognitive and functional outcomes in the post-stroke period from earlier data, but the current evidence does not support a confident recommendation in this domain.

**Evidence rating basis:** Moderate (low confidence; materially weakened by ICTUS null result and absence of subsequent large-trial replication). Inconsistent overall picture.
...
## Citicoline versus other choline forms

Alpha-GPC has a growing evidence base for cognitive outcomes in older adults and may have stronger cholinergic effects. Direct head-to-head comparison data with citicoline is limited. Choline bitartrate has a much smaller cognitive evidence base. Cross-form generalisation is not supported.

## Funding and independence

The healthy adult evidence base has meaningful Cognizin (Kyowa Hakko) manufacturer involvement. The older adult and clinical population evidence is more mixed, with substantial independent and publicly funded European trial data. The ICTUS stroke trial was publicly funded, which reinforces the weight that should be given to its null result relative to earlier industry-adjacent positive trials.
...
- Dávalos A et al. Citicoline in the treatment of acute ischaemic stroke (ICTUS trial): a randomised, placebo-controlled, multicentre study. Lancet. 2012;380(9839):349-357.
- Gareri P et al. Effectiveness and safety of citicoline in mild vascular cognitive impairment: the IDEALE study. Clin Interv Aging. 2013;8:131-137.
...
- Wurtman RJ et al. Synaptic proteins and phospholipids are increased in gerbil brain by administering uridine plus docosahexaenoic acid orally. Brain Res. 2006;1088(1):83-92.