...
tags: ["vitamin-c", "ascorbic-acid", "ascorbate", "immune-function", "collagen", "antioxidant", "iron-absorption", "common-cold", "scurvy"]
aliases: ["vitamin c", "ascorbic acid", "ascorbate", "l-ascorbic acid", "vitamin c supplement", "ascorbic acid supplement", "immune vitamin", "cold prevention"]
primaryRating: "Strong"
primaryOutcome: "Correction of vitamin C low status and prevention of deficiency-related pathology (scurvy) -- Strong rating applies to this context only and does not extend to prevention or pharmacological use in replete adults"
outcomeType: "clinical"
numberOfRCTs: 12
totalParticipantN: 2800
riskOfBiasSummary: "Low to some concerns; correction of deficiency is well-established and not seriously contested; repletion trials are consistent and the physiological mechanism is well-characterised"
consistencyFlag: "Consistent"
ratingJustification: "Strong rating reflects consistent evidence across repletion trials and well-characterised dose-response relationships for deficiency correction. The rating is scoped to this context. Vitamin C modulates immune biomarkers in low-status individuals but this does not translate to meaningful reduction in infection incidence in replete adults."
surrogateOnly: false
formSpecificEvidence: true
formStudied: "Ascorbic acid (most trials); sodium ascorbate and calcium ascorbate are equivalent in bioavailability at equivalent doses; liposomal vitamin C has higher acute plasma concentrations but the clinical relevance of this distinction is not established"
additionalOutcomes:
  - outcome: "Reduction in common cold duration in the general population"
    rating: "Moderate"
    outcomeType: "clinical"
    numberOfRCTs: 31
    totalParticipantN: 9745
    riskOfBiasSummary: "Some concerns to low; large Cochrane review with reasonable quality trials; effect size is small and consistent"
    consistencyFlag: "Consistent"
    ratingNote: "Consistent modest reduction in duration (approximately 8% relative reduction in adults, typically less than one day in absolute terms; 14% in children) with regular supplementation. Does not prevent colds in the general population. Therapeutic dosing at onset does not meaningfully reduce duration or severity."
  - outcome: "Prevention of common cold in individuals under high physical stress"
    rating: "Strong"
    outcomeType: "clinical"
    numberOfRCTs: 6
    totalParticipantN: 642
    riskOfBiasSummary: "Low to some concerns; trials in marathon runners, skiers, and military personnel are consistent"
    consistencyFlag: "Consistent"
    ratingNote: "Approximately 50% reduction in cold incidence in individuals exposed to acute physical stress or extreme environmental conditions. This effect does not generalise to the broader population."
  - outcome: "Iron absorption enhancement"
    rating: "Strong"
    outcomeType: "surrogate-biomarker"
    numberOfRCTs: 14
    totalParticipantN: 980
    riskOfBiasSummary: "Low to some concerns; mechanism is well-characterised; effect on non-haem iron absorption is consistent across populations"
    consistencyFlag: "Consistent"
    ratingNote: "Vitamin C reliably enhances non-haem iron absorption when consumed simultaneously. Clinical relevance is highest in individuals with low iron status or those relying on plant-based iron sources."
  - outcome: "Cardiovascular disease prevention in replete adults"
    rating: "Insufficient"
    outcomeType: "clinical"
    numberOfRCTs: 8
    totalParticipantN: 64000
    riskOfBiasSummary: "Low risk of bias in large trials; consistently null findings for hard cardiovascular endpoints"
    consistencyFlag: "Consistent"
    ratingNote: "No reduction in cardiovascular events or mortality in large, well-powered trials in replete populations. Observational associations do not translate to benefit in RCTs."
  - outcome: "Cancer prevention in replete adults"
    rating: "Insufficient"
    outcomeType: "clinical"
    numberOfRCTs: 5
    totalParticipantN: 47000
    riskOfBiasSummary: "Low risk of bias; large trials consistently null for cancer incidence and mortality"
    consistencyFlag: "Consistent"
  - outcome: "Cognitive function and dementia prevention"
    rating: "Insufficient"
    outcomeType: "clinical"
    numberOfRCTs: 4
    totalParticipantN: 14000
    riskOfBiasSummary: "Low to some concerns; no consistent cognitive benefit in replete adults"
    consistencyFlag: "Inconsistent"
  - outcome: "Skin outcomes (wrinkles, photoageing) in replete adults"
    rating: "Emerging"
    outcomeType: "clinical"
    numberOfRCTs: 8
    totalParticipantN: 520
    riskOfBiasSummary: "High concerns; small trials, variable outcome measures, short durations; topical and oral forms conflated in many reviews"
...
populationNotes: "Smokers have substantially higher vitamin C requirements due to increased oxidative turnover -- UK recommendations are 80mg/day for smokers versus 40mg/day for non-smokers. Individuals with low dietary intake of fruits and vegetables are at meaningful risk of low status. Individuals with malabsorption conditions including Crohn's disease and coeliac disease may have impaired absorption. Individuals relying on plant-based iron sources benefit from co-consumption of vitamin C with iron-containing meals. The stress-protective effect for cold prevention applies specifically to individuals experiencing high acute physical or environmental stress, not to sedentary adults."
safetyFlag: true
safetyNotes: "Vitamin C is generally well-tolerated. GI symptoms including diarrhoea, nausea, and abdominal cramps are the most common adverse effects and are dose-dependent -- typically occurring above 1,000mg per day. The tolerable upper intake level is 2,000mg per day for adults. High-dose supplementation increases urinary oxalate excretion and may increase kidney stone risk in susceptible individuals; evidence is inconsistent but suggests a possible increased risk in men at high doses. Individuals with haemochromatosis or other iron overload conditions should exercise caution as vitamin C enhances iron absorption and may exacerbate iron accumulation. Vitamin C at high doses may interfere with some laboratory tests including glucose oxidase-based glucose assays and guaiac-based faecal occult blood tests. Concerns about high-dose vitamin C and rebound scurvy on abrupt cessation are theoretical and not well-supported by clinical evidence."
...
relatedEntries: ["iron", "folate", "zinc", "collagen"]
cardDescription: "Vitamin C has a well-established and important role in correcting low status and in collagen synthesis, immune function, and iron absorption. The evidence for cold prevention in ordinary healthy adults is more modest than popular belief suggests -- it does not prevent colds, though it reduces duration slightly. Large prevention trials in replete adults are consistently null for cardiovascular and cancer outcomes."
---
...
Hallberg L et al. conducted foundational work establishing the dose-response relationship between simultaneous vitamin C intake and non-haem iron absorption. The effect is mediated via reduction of ferric to ferrous iron and formation of soluble iron-ascorbate complexes. Approximately 50-100mg of vitamin C consumed simultaneously with an iron-containing meal meaningfully enhances non-haem iron absorption; effects plateau at higher doses.

Cook JD and Monsen ER (1977) and subsequent studies confirmed the clinical relevance of this interaction across varied dietary contexts. The interaction is inhibited by cooking, which oxidises ascorbate, reinforcing the relevance of raw fruit and vegetable consumption alongside iron-rich foods.

**Evidence rating basis:** Strong for surrogate biomarker (iron absorption). Clinical translation to iron status outcomes in iron-deficient individuals is supported by observational and intervention evidence.

### Cardiovascular disease prevention

The Physicians' Health Study II (Sesso HD et al., 2008, JAMA; RCT, n = 14,641, male physicians, 8 years follow-up) found no significant reduction in major cardiovascular events with 500mg vitamin C daily versus placebo.

The Women's Antioxidant Cardiovascular Study (Cook NR et al., 2007, Archives of Internal Medicine; RCT, n = 8,171, women at high cardiovascular risk, 9.4 years) found no significant reduction in major cardiovascular events with 500mg vitamin C daily.

The SU.VI.MAX trial (Hercberg S et al., 2004, Archives of Internal Medicine; RCT, n = 13,017, French adults, 7.5 years, combination antioxidant supplement including 120mg vitamin C) found no overall benefit for cardiovascular events.

**Evidence rating basis:** Insufficient. Large, well-powered trials with consistently null findings. Observational associations are not supported by intervention evidence.

### Cancer prevention

The Physicians' Health Study II found no significant effect on cancer incidence or cancer mortality with 500mg daily vitamin C over 8 years in male physicians.

The Women's Antioxidant and Folic Acid Cardiovascular Study found no reduction in cancer incidence with antioxidant supplementation including vitamin C.

Multiple meta-analyses of antioxidant supplementation trials, including the Cochrane review by Bjelakovic et al., found no evidence of cancer prevention benefit and raised questions about potential harm at high doses of some antioxidants (though specific vitamin C concerns are less established than for beta-carotene in smokers).

**Evidence rating basis:** Insufficient. Large trials consistently null. No cancer site has demonstrated consistent preventive benefit from supplemental vitamin C in replete adults.

### Skin and collagen outcomes

Small trials have examined oral vitamin C supplementation and skin outcomes including wrinkle depth, skin elasticity, and photoageing markers. Pullar JM et al. (2017, Nutrients; review) summarised the biological rationale and observational associations. Controlled intervention trials are limited in size and duration, with variable outcome measures.

Nusgens BV et al. and subsequent work confirmed that oral supplementation in low-status individuals improves collagen synthesis markers, but effects in replete individuals are less consistent.

**Evidence rating basis:** Emerging. Biological plausibility is strong; current evidence is preliminary with small trials, short durations, and no large RCTs. Not sufficient to support confident conclusions about skin outcomes in replete adults.
...
Sesso HD et al. (2008). Vitamins E and C in the prevention of cardiovascular disease in men: the Physicians' Health Study II randomized controlled trial. JAMA, 300(18), 2123-2133. doi:10.1001/jama.2008.600

Cook NR et al. (2007). A randomized factorial trial of vitamins C and E and beta carotene in the secondary prevention of cardiovascular events in women: results from the Women's Antioxidant Cardiovascular Study. Archives of Internal Medicine, 167(15), 1610-1618. doi:10.1001/archinte.167.15.1610

Hercberg S et al. (2004). The SU.VI.MAX Study: a randomized, placebo-controlled trial of the health effects of antioxidant vitamins and minerals. Archives of Internal Medicine, 164(21), 2335-2342. doi:10.1001/archinte.164.21.2335

Pullar JM et al. (2017). The roles of vitamin C in skin health. Nutrients, 9(8), 866. doi:10.3390/nu9080866
...
Padayatty SJ et al. (2004). Vitamin C pharmacokinetics: implications for oral and intravenous use. Annals of Internal Medicine, 140(7), 533-537. doi:10.7326/0003-4819-140-7-200404060-00010