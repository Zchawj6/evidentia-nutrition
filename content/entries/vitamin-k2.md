...
tags: ["vitamin-k2", "menaquinone", "mk7", "mk4", "bone-health", "cardiovascular", "vitamin-d"]
aliases: ["menaquinone", "MK-7", "MK-4", "vitamin K", "K2"]
primaryRating: "Moderate"
primaryOutcome: "Bone mineral density attenuation in postmenopausal women (MK-7 at nutritional doses)"
outcomeType: "clinical"
numberOfRCTs: 20
totalParticipantN: 3800
riskOfBiasSummary: "Variable across heterogeneous MK-4 and MK-7 trials with different doses, populations, and endpoints; bone density trials concentrated in a small number of industry-linked research groups; no large independent multi-centre replication trials available"
consistencyFlag: "Mixed"
surrogateOnly: false
formSpecificEvidence: true
formStudied: "MK-7 (menaquinone-7) and MK-4 (menaquinone-4) -- evidence is not transferable between forms without direct comparative data"
additionalOutcomes:
  - outcome: "Fracture risk reduction (MK-4 at pharmacological doses only)"
    rating: "Emerging"
    outcomeType: "clinical"
    numberOfRCTs: 6
    totalParticipantN: 1200
    riskOfBiasSummary: "Evidence applies to MK-4 at 45mg/day in Japanese osteoporotic women; not established for MK-7 at nutritional doses"
    consistencyFlag: "Mixed"
  - outcome: "Cardiovascular calcification biomarkers and arterial stiffness"
    rating: "Emerging"
    outcomeType: "exploratory-biomarker"
    numberOfRCTs: 5
    totalParticipantN: 800
    riskOfBiasSummary: "Small RCTs with surrogate endpoints; no event-level RCT evidence; dp-ucMGP clinical thresholds not established; cardiovascular associations observational only"
    consistencyFlag: "Mixed"
  - outcome: "General supplementation in adults with adequate dietary intake"
    rating: "Insufficient"
    outcomeType: "clinical"
    numberOfRCTs: 3
    totalParticipantN: 400
    riskOfBiasSummary: "Limited trials in replete populations without specific indication"
...
populationNotes: "Evidence strongest in postmenopausal women with bone density concerns and individuals on vitamin D supplementation. Low dietary K2 intake is common in Western populations but clinical deficiency is not formally defined. Anticoagulant users require clinical review before supplementation."
safetyFlag: true
safetyNotes: "Vitamin K2 interacts with warfarin and other vitamin K antagonist anticoagulants -- supplementation is contraindicated without clinical supervision as it affects INR stability. MK-7's long half-life makes any anticoagulant interaction more sustained. Theoretical concern about hypercoagulability at very high doses has not been demonstrated clinically at supplemental doses. Pregnancy: no established safety concern at dietary-level intake; high-dose supplementation not studied in pregnancy. No established upper tolerable intake limit; toxicity not demonstrated at supplemental doses."
...
cardDescription: "Distinct from vitamin K1 and frequently low in Western diets. Evidence for bone outcomes in postmenopausal women is meaningful. Form and dose specificity matter considerably -- evidence from MK-4 trials does not transfer to MK-7."
---
...
This is a pharmacological intervention at doses approximately 500 times higher than the MK-7 doses used in European nutritional trials. The population is Japanese osteoporotic women whose dietary patterns and baseline K2 status differ from Western populations. Whether MK-7 at nutritional doses produces equivalent fracture risk reduction has not been established.

**Evidence rating basis:** Emerging for MK-7 at nutritional doses. Moderate for MK-4 at 45mg/day in osteoporotic Japanese women, but this is a pharmaceutical not a supplement application and the evidence does not transfer.
...
No randomised controlled trial has demonstrated that reduction in dp-ucMGP through K2 supplementation reduces cardiovascular events. Observational evidence from the Rotterdam Study and EPIC-NL shows inverse associations between dietary K2 intake and coronary heart disease risk, but observational associations cannot establish causation.

**outcomeType: exploratory-biomarker**
**Evidence rating basis:** Emerging. Directionally consistent biomarker signal; dp-ucMGP clinical thresholds not established; no clinical event evidence from RCTs; observational associations non-causal.

### Vitamin D3 and K2 co-administration

Vitamin D3 increases intestinal calcium absorption. K2 activates osteocalcin and MGP, directing absorbed calcium to bone and away from soft tissues. The theoretical concern is that high-dose vitamin D3 without adequate K2 may allow inappropriate calcium deposition.

This hypothesis is mechanistically plausible. Wen et al. (2021) found that combined D3 and K2 supplementation produced greater improvements in bone mineral density than either alone in postmenopausal women. Direct evidence from adequately powered combination trials is limited and findings are mixed. Clinical benefit from co-administration has not been established with confidence.

This is a secondary hypothesis supported by mechanism and limited trial data. It should not be presented as a primary evidence-based application.
...
**Pregnancy:** No established safety concern exists with dietary-level K2 intake in pregnancy. High-dose supplementation has not been specifically studied in pregnant women and caution is appropriate. The anticoagulant interaction caveat is particularly important in pregnancy where anticoagulant use may occur.

## Individual variation

**Dietary intake:** Western dietary patterns are generally low in K2, particularly MK-7, due to low natto consumption. Low intake is common but clinical deficiency in the sense of a defined syndrome is not established.

**Vitamin D supplementation:** Those taking vitamin D3, particularly at higher doses, have a plausible mechanistic rationale for K2 co-administration, though clinical benefit has not been definitively established.

**Bone health status:** Individuals with low bone mineral density, osteopenia, or osteoporosis have the most to gain from optimising K2 status. DEXA scanning provides direct assessment.
...
The MK-7 bone evidence base has significant NattoPharma (now Gnosis by Lesaffre) involvement, including in the Knapen et al. trials that form the core of the MK-7 bone evidence. No large independent multi-centre replication trials are currently available. The Japanese MK-4 fracture evidence was largely publicly or institutionally funded, which strengthens confidence in those findings. Independent replication of the MK-7 bone findings would substantially strengthen the evidence base.
