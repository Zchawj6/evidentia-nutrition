...
slug: "resveratrol"
category: "longevity"
tags: ["resveratrol", "polyphenol", "longevity", "sirtuin", "SIRT1", "anti-ageing", "cardiovascular"]
aliases: ["trans-resveratrol", "3,5,4'-trihydroxystilbene"]
primaryRating: "Insufficient"
primaryOutcome: "Longevity, cardiovascular protection, and metabolic health in humans"
outcomeType: "clinical"
numberOfRCTs: 18
totalParticipantN: 1100
riskOfBiasSummary: "Small sample sizes, short durations, heterogeneous dosing, and inconsistent outcome measures across trials; several well-powered trials are null"
consistencyFlag: "Inconsistent"
surrogateOnly: false
formSpecificEvidence: true
formStudied: "Trans-resveratrol (oral supplementation)"
additionalOutcomes:
  - outcome: "Cardiovascular biomarker effects (blood pressure, lipids, inflammation)"
    rating: "Insufficient"
    outcomeType: "surrogate-biomarker"
    numberOfRCTs: 12
    totalParticipantN: 700
    riskOfBiasSummary: "Mixed results across well-controlled trials; no consistent direction of effect"
    consistencyFlag: "Inconsistent"
  - outcome: "Metabolic outcomes in type 2 diabetes and insulin resistance"
    rating: "Emerging"
    outcomeType: "clinical"
    numberOfRCTs: 6
    totalParticipantN: 350
    riskOfBiasSummary: "Small trials, short durations, modest and inconsistent effects on glucose and insulin sensitivity"
    consistencyFlag: "Mixed"
  - outcome: "SIRT1 activation and downstream longevity pathway modulation in humans"
    rating: "Insufficient"
    outcomeType: "exploratory-biomarker"
    numberOfRCTs: 4
    totalParticipantN: 180
    riskOfBiasSummary: "Human data does not replicate the consistent SIRT1 activation seen in preclinical models"
    consistencyFlag: "Inconsistent"
individualisationRelevance: "Low"
bloodTestingRelevant: false
geneticVariationRelevant: false
populationSpecific: false
populationNotes: "No population has been identified in which resveratrol supplementation produces consistent and clinically meaningful benefit at commercially available doses. A modest signal in type 2 diabetes and metabolic syndrome populations exists but is not yet robust enough to support targeted recommendations."
safetyFlag: true
safetyNotes: "Generally well-tolerated at doses up to 1g/day in short-term trials. GI discomfort is the most commonly reported side effect. At high doses (2.5g/day and above), reversible hepatotoxicity signals have been reported in some individuals. Resveratrol inhibits CYP450 enzymes and may interact with anticoagulants, NSAIDs, and some statins -- clinically relevant for individuals on these medications. Oestrogenic activity has been demonstrated in vitro; the clinical significance in humans is uncertain but warrants caution in oestrogen-sensitive conditions."
...
relatedEntries: ["coq10", "vitamin-d"]
cardDescription: "One of the most prominent examples of preclinical promise failing to translate into human evidence. The longevity narrative is driven by animal and cell data that has not held up in clinical trials."
---
...
Human trials examining blood pressure, lipid profiles, endothelial function, CRP, and other cardiovascular markers have returned mixed results. Fogacci et al. (2019) conducted a meta-analysis of RCTs and reported a modest reduction in systolic blood pressure at doses above 300mg/day, but this effect was not consistent across all trials and did not reach clinical decisiveness. Several well-designed trials including Poulsen et al. (2013) in obese men found no significant effects on cardiovascular risk markers. Pollack et al. (2017) found improvements in vascular function but not glucose metabolism in older adults.

The French paradox epidemiological argument has been undermined by cohort data using urinary resveratrol metabolites, which provide more objective exposure measurement than dietary recall. Semba et al. (2014) found no association between urinary resveratrol metabolites and cardiovascular outcomes or mortality in a large cohort study. The epidemiological signal, where it exists, is more plausibly explained by overall dietary pattern, lifestyle, and alcohol-related confounding.

**Evidence rating basis:** Insufficient. No consistent direction of effect across well-controlled trials. Possible modest dose-dependent BP signal requires replication. No hard cardiovascular endpoint trials exist.
...
**Evidence rating basis:** Emerging. Small, inconsistent but directionally positive signal in metabolic populations. Not robust enough for targeted clinical recommendation.
...
**Confounded epidemiology:** The French paradox hypothesis is more plausibly explained by overall dietary pattern, lifestyle, and alcohol-related confounding than by resveratrol specifically.

## Biomarker and surrogate considerations

No validated surrogate for resveratrol's proposed clinical effects exists in humans. SIRT1 activity, NAD+ levels, and plasma resveratrol concentrations are measurable but do not reliably predict clinical outcomes. Interpreting a detectable blood level as confirmation of biological activity is not supported by the evidence.
...
- Borra MT et al. Mechanism of human SIRT1 activation by resveratrol. J Biol Chem. 2005;280(17):17187-17195.
- Walle T. Bioavailability of resveratrol. Ann NY Acad Sci. 2011;1215:9-15.
- Patel KR et al. Clinical pharmacology of resveratrol and its metabolites in colorectal cancer patients. Cancer Res. 2011;70(19):7392-7399.
- Liu K et al. Effects of resveratrol on glycemic control: a meta-analysis of randomized controlled trials. Nutrients. 2022;14(2):269.
- Fogacci F et al. Effect of resveratrol on blood pressure: a systematic review and meta-analysis. J Clin Med. 2019;8(2):201.
- Poulsen MM et al. High-dose resveratrol supplementation in obese men. Diabetes. 2013;62(4):1186-1195.
- Pollack RM et al. Resveratrol improves vascular function and mitochondrial number but not glucose metabolism in older adults. J Gerontol A Biol Sci Med Sci. 2017;72(12):1703-1709.
- Semba RD et al. Resveratrol levels and all-cause mortality in older community-dwelling adults. JAMA Intern Med. 2014;174(7):1077-1084.
...
- Tome-Carneiro J et al. Resveratrol and clinical trials: the crossroads from in vitro studies to human evidence. Curr Pharm Des. 2013;19(34):6064-6093.
