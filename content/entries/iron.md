...
tags: ["iron", "anaemia", "fatigue", "pregnancy", "iron-deficiency", "haemoglobin", "restless-legs", "heart-failure", "ferritin", "haemochromatosis"]
aliases: ["Fe", "iron supplementation", "oral iron", "iron deficiency anaemia", "IDA", "ferrous sulfate", "ferric carboxymaltose"]
primaryRating: "Strong"
primaryOutcome: "Correction of iron deficiency and iron-deficiency anaemia in deficient populations. Strong rating applies to this indication only and does not extend to general fatigue, exercise performance, or any benefit in iron-replete adults."
outcomeType: "clinical"
numberOfRCTs: 35
totalParticipantN: 7500
riskOfBiasSummary: "Low to moderate overall. Multiple randomised trials and systematic reviews demonstrate consistent haemoglobin and ferritin improvements in iron-deficient populations with low risk of bias. Additional outcomes (fatigue, exercise performance) are supported by smaller trials with more variable methodology."
consistencyFlag: "Consistent"
ratingJustification: "Strong evidence from RCTs and meta-analyses supports iron supplementation for correcting iron deficiency and iron-deficiency anaemia, with large, clinically meaningful and reproducible improvements in haemoglobin and iron stores. This effect is restricted to individuals with established deficiency and does not generalise to iron-replete populations, in whom iron supplementation provides no benefit and carries risk."
surrogateOnly: false
formSpecificEvidence: true
formStudied: "Ferrous salts (sulfate, fumarate, gluconate) are the most studied oral forms and are considered equivalent in clinical trials. Intravenous preparations (ferric carboxymaltose, iron sucrose, ferric derisomaltose) are used in defined clinical settings where oral iron fails or is inappropriate. Evidence from intravenous preparations does not transfer to oral iron for the same indications, and vice versa. Alternate-day oral dosing is supported by evidence for improved net absorption in iron-depleted individuals."
additionalOutcomes:
  - outcome: "Fatigue in iron deficiency without anaemia"
    rating: "Moderate"
    outcomeType: "clinical"
    numberOfRCTs: 5
    totalParticipantN: 750
    riskOfBiasSummary: "Some concerns; trials are population-specific (predominantly premenopausal women), fatigue measures are heterogeneous, and sample sizes are modest"
    consistencyFlag: "Mixed"
    ratingNote: "Moderate (deficiency-dependent effect). Some trials report modest improvements in fatigue in iron-deficient, non-anaemic individuals, particularly premenopausal women with low ferritin. Effect size is smaller than in iron-deficiency anaemia and findings are not consistent across all trials. Not generalisable to iron-replete populations."

  - outcome: "Cognitive function in iron-deficient children"
    rating: "Moderate"
    outcomeType: "clinical"
    numberOfRCTs: 10
    totalParticipantN: 1200
    riskOfBiasSummary: "Some concerns; consistent direction of effect but population-specific, and studies vary in cognitive domains assessed"
    consistencyFlag: "Generally consistent"
    ratingNote: "Moderate (deficiency-dependent effect). Meta-analyses report improvements in cognitive outcomes in iron-deficient children, with effects concentrated in attention and learning. No consistent benefit has been demonstrated in iron-replete children or adults."

  - outcome: "Restless legs syndrome symptom improvement"
    rating: "Moderate"
    outcomeType: "clinical"
    numberOfRCTs: 7
    totalParticipantN: 750
    riskOfBiasSummary: "Low to moderate; several RCTs including intravenous iron preparations, with consistent findings in low-ferritin populations"
    consistencyFlag: "Generally consistent"
    ratingNote: "Moderate (ferritin-dependent effect). Iron supplementation improves RLS symptom severity in patients with low ferritin, particularly below approximately 50–75 µg/L. Effects are consistent across oral and intravenous routes. Benefit is not established in patients with normal iron status."

  - outcome: "Heart failure symptom improvement (intravenous iron)"
    rating: "Moderate"
    outcomeType: "clinical"
    numberOfRCTs: 4
    totalParticipantN: 3000
    riskOfBiasSummary: "Low; large well-designed RCTs in defined clinical populations with low risk of bias"
    consistencyFlag: "Consistent"
    ratingNote: "Moderate (clinical population, intravenous route only). Intravenous iron improves symptoms and functional capacity in iron-deficient heart failure patients. No consistent mortality benefit has been established. This evidence applies only to intravenous preparations in this specific clinical setting and does not generalise to oral iron or to iron deficiency without heart failure."

  - outcome: "Exercise performance in iron-deficient individuals"
    rating: "Emerging"
    outcomeType: "clinical"
    numberOfRCTs: 6
    totalParticipantN: 650
    riskOfBiasSummary: "Some concerns; small trials, heterogeneous populations and performance measures, short durations"
    consistencyFlag: "Mixed"
    ratingNote: "Emerging (deficiency-dependent effect). Small trials report modest improvements in physical performance and VO2 max in iron-deficient individuals, particularly female athletes. Findings are inconsistent and effect sizes are small. No benefit is established in iron-replete individuals."

individualisationRelevance: "High"
bloodTestingRelevant: true
geneticVariationRelevant: true
populationSpecific: true
populationNotes: "Clinical benefit from iron supplementation is almost entirely determined by baseline iron status. Clear and reproducible benefit exists in iron deficiency, iron-deficiency anaemia, pregnancy with iron deficiency, and defined clinical populations including iron-deficient heart failure and restless legs syndrome with low ferritin. Premenopausal women, pregnant individuals, distance runners, and those following plant-based diets are at higher risk of iron deficiency and represent populations where testing and supplementation are most likely to be relevant. Individuals with haemochromatosis or other iron overload conditions must not supplement without medical supervision. Iron supplementation in iron-replete individuals provides no clinical benefit and carries risk of harm."
safetyFlag: true
safetyNotes: "Iron is generally safe when used appropriately in deficient populations at recommended doses. Common adverse effects with oral iron include gastrointestinal symptoms: nausea, constipation, and dark stools. Alternate-day dosing and taking iron with food can reduce tolerability issues, though food reduces absorption. Risk of iron overload exists in susceptible individuals, particularly those with hereditary haemochromatosis (HFE gene mutations), who should not supplement without medical supervision and monitoring. Ferritin should not be used in isolation to guide supplementation decisions in the presence of acute or chronic inflammation, as it is an acute phase reactant and may be falsely elevated. Drug interactions: iron reduces absorption of levothyroxine, quinolone antibiotics (ciprofloxacin, levofloxacin), tetracycline antibiotics, and levodopa; these should be taken at least two hours apart. Proton pump inhibitors and H2 blockers reduce gastric acid and impair iron absorption with chronic use. Intravenous iron carries a small risk of hypersensitivity reactions and should only be administered in a clinical setting with appropriate monitoring. Iron supplementation in pregnancy should be guided by blood tests and clinical assessment; practice varies by healthcare system, with some guidelines recommending routine low-dose supplementation and others using test-guided strategies. High-dose supplementation in replete pregnant individuals is not recommended and carries risk of adverse effects."
lastReviewed: "2026-04"
reviewInterval: 12
version: "2"
advisoryReview: false
recusalApplied: false
relatedEntries: ["vitamin-c", "folate", "vitamin-b12", "magnesium", "zinc"]
cardDescription: "Iron has strong evidence for correcting iron deficiency and iron-deficiency anaemia, with large and reproducible improvements in haemoglobin and iron stores. This benefit is strictly dependent on baseline status: no clinical benefit has been established in iron-replete individuals, and supplementation without confirmed deficiency carries risk."
---
...
Peña-Rosas JP et al. conducted a Cochrane systematic review of daily oral iron supplementation in women of reproductive age, synthesising data from over 60 trials. Daily supplementation increased haemoglobin, reduced anaemia prevalence, and improved ferritin. DeLoughery TG et al. (2024) published an AGA Clinical Practice Update in Clinical Gastroenterology and Hepatology reviewing oral iron therapy across gastrointestinal clinical contexts, noting consistent haemoglobin and ferritin responses across ferrous salt formulations. Tolkien Z et al. (2015) conducted a systematic review and meta-analysis in PLOS ONE examining gastrointestinal adverse effects, confirming that ferrous sulfate is effective but associated with higher rates of GI intolerance than some alternative formulations. Stoffel NU et al. (2017), published in Lancet Haematology, demonstrated in a randomised crossover trial that alternate-day dosing results in superior fractional iron absorption compared to daily dosing in iron-depleted women, due to suppression of the hepcidin response with daily administration. This finding has practical implications for clinical dosing strategies.

**Evidence rating basis:** Strong. Multiple well-designed RCTs and high-quality systematic reviews with consistent findings, low to moderate risk of bias, and large clinically meaningful effect sizes in deficient populations.

---

### Fatigue without anaemia

Verdon F et al. (2003), in a randomised placebo-controlled trial published in the BMJ, enrolled 144 women with unexplained fatigue and low ferritin but normal haemoglobin. Supplementation with 80 mg elemental iron daily for four weeks produced a modest but statistically significant reduction in fatigue scores compared to placebo, with effect sizes larger in women with more severe fatigue at baseline. A subsequent trial by Vaucher P et al. (2012, Canadian Medical Association Journal) in non-anaemic women similarly demonstrated improvement in fatigue and vitality measures. Not all trials in this population have shown significant benefit, and the effect is smaller and less consistent than in iron-deficiency anaemia.

**Evidence rating basis:** Moderate. Positive signal in a defined population (non-anaemic iron-deficient women) but modest effect sizes, heterogeneous outcome measures, and inconsistency across trials prevent a Strong rating.

---

### Cognitive function in iron-deficient children

Low M et al. (2013), in a meta-analysis published in the American Journal of Clinical Nutrition, analysed randomised trials of iron supplementation on cognitive outcomes in iron-deficient children. Pooled analyses indicated improvements in attention, concentration, and IQ measures in deficient children, with larger effects in those with more severe deficiency at baseline. The evidence was more consistent for attention than for other cognitive domains. No consistent benefit was identified in iron-replete children.

**Evidence rating basis:** Moderate. Consistent direction across trials in a specific deficient population, but variation in cognitive domains assessed, population characteristics, and study quality limit the rating.

---

### Restless legs syndrome

Trotti LM et al. (2012) conducted a Cochrane review examining iron supplementation for restless legs syndrome, including trials of both oral and intravenous iron. Intravenous iron produced consistent and clinically meaningful reductions in RLS symptom severity, particularly in patients with ferritin below 50–75 µg/L. Oral iron showed more modest and variable effects. Allen RP et al. (2011, Sleep Medicine) demonstrated that low CSF ferritin, a marker of brain iron stores, is found in patients with RLS even when serum ferritin is borderline, providing mechanistic context for the treatment effect. The clinical evidence is not limited to mechanistic rationale; randomised trials provide direct evidence of symptom reduction.

**Evidence rating basis:** Moderate. Consistent evidence of benefit in low-ferritin populations across both oral and intravenous routes, though trials are small and the optimal ferritin threshold for treatment selection requires further definition.

---

### Heart failure with iron deficiency (intravenous iron)

Anker SD et al. (2009, FAIR-HF, New England Journal of Medicine) randomised 459 patients with systolic heart failure and iron deficiency (with or without anaemia) to intravenous ferric carboxymaltose or placebo. At 24 weeks, the treatment group showed significant improvements in six-minute walk test, NYHA class, and patient global assessment, with no statistically significant mortality benefit. Ponikowski P et al. (2015, CONFIRM-HF, European Heart Journal) randomised 304 patients with stable heart failure and iron deficiency to ferric carboxymaltose or placebo over 52 weeks. Functional capacity improved significantly in the treatment group; the trial was not powered for mortality endpoints. A pooled patient-level meta-analysis (Jankowska EA et al., 2016, European Journal of Heart Failure) found consistent functional improvements but no statistically significant reduction in mortality or hospitalisation.

**Evidence rating basis:** Moderate. Multiple well-designed large RCTs with consistent functional benefit. Rating is not Strong because mortality benefit is not established and the evidence is specific to intravenous iron in this clinical setting.

---

### Exercise performance

Burden RJ et al. (2015) published a systematic review in Sports Medicine examining the effects of iron supplementation on physical performance in iron-deficient athletes. Across studies, supplementation was associated with modest improvements in VO2 max and submaximal exercise efficiency in iron-deficient individuals, particularly non-anaemic female athletes with low ferritin. Effect sizes were small and inconsistency was notable across trials due to heterogeneity in populations, iron status at baseline, supplementation protocols, and performance outcomes measured.

**Evidence rating basis:** Emerging. Positive signal in iron-deficient athletes but small, inconsistent effects, limited trial quality, and insufficient evidence to draw reliable conclusions about the magnitude or generalisability of benefit.

---

## How to interpret this evidence

The central interpretive principle for iron is that status determines outcome. This is not a standard supplement category where a molecule is hypothesised to produce benefit across a general population. Iron is an essential nutrient with tightly regulated homeostasis, and the clinical benefit of supplementation is almost entirely restricted to individuals whose status is genuinely inadequate. For most outcomes in this entry, the question is not whether iron supplementation works, in the right population, it demonstrably does, but whether the individual in question has the status that makes benefit possible.

A common misreading of this evidence is to infer from the strong deficiency-correction data that iron is an effective fatigue or energy supplement more broadly. It is not. Fatigue is a highly non-specific symptom, and iron deficiency accounts for only a subset of fatigue presentations. Supplementing without testing to confirm deficiency may produce a placebo response, miss the underlying cause of fatigue, or in susceptible individuals cause harm. The appropriate response to fatigue is diagnostic assessment, not empirical supplementation.

The second interpretive challenge is ferritin interpretation in the context of inflammation. Because ferritin rises as an acute phase reactant, a normal or elevated ferritin does not rule out functional iron deficiency in someone with chronic inflammatory disease, infection, or malignancy. In those contexts, transferrin saturation and soluble transferrin receptor provide a more reliable picture. Treating iron deficiency in inflammatory states is also more complex, as hepcidin suppresses absorption; intravenous rather than oral iron is often required. These nuances mean that assessment and management of iron status in inflammatory populations requires clinical oversight and should not be approached through self-supplementation.

---

## Key references

Peña-Rosas JP et al. (2015). Daily oral iron supplementation during pregnancy. Cochrane Database of Systematic Reviews, (7), CD004736. doi:10.1002/14651858.CD004736.pub5

DeLoughery TG et al. (2024). AGA Clinical Practice Update on Management of Iron Deficiency Anemia: Expert Review. Clinical Gastroenterology and Hepatology, 22(8), 1575–1583. doi:10.1016/j.cgh.2024.03.046
...
Stoffel NU et al. (2017). Iron absorption from supplements is greater with alternate day dosing in iron-deficient women. Lancet Haematology, 4(11), e524–e533. doi:10.1016/S2352-3026(17)30182-5
...
Vaucher P et al. (2012). Effect of iron supplementation on fatigue in nonanemic menstruating women with low ferritin: a randomized controlled trial. Canadian Medical Association Journal, 184(11), 1247–1254. doi:10.1503/cmaj.110950

Low M et al. (2013). Effects of iron supplementation on cognitive function in children with non-anaemic iron deficiency: a systematic review. American Journal of Clinical Nutrition, 98(6), 1383–1390. doi:10.3945/ajcn.113.066438

Trotti LM et al. (2012). Iron for restless legs syndrome. Cochrane Database of Systematic Reviews, (5), CD007834. doi:10.1002/14651858.CD007834.pub2

Allen RP et al. (2011). Restless legs syndrome/Willis-Ekbom disease diagnostic criteria: updated International Restless Legs Syndrome Study Group (IRLSSG) consensus criteria. Sleep Medicine, 15(8), 860–873. doi:10.1016/j.sleep.2014.03.025

Anker SD et al. (2009). Ferric carboxymaltose in patients with heart failure and iron deficiency (FAIR-HF). New England Journal of Medicine, 361(25), 2436–2448. doi:10.1056/NEJMoa0908355

Ponikowski P et al. (2015). Beneficial effects of long-term intravenous iron therapy with ferric carboxymaltose in patients with symptomatic heart failure and iron deficiency (CONFIRM-HF). European Heart Journal, 36(11), 657–668. doi:10.1093/eurheartj/ehu385

Burden RJ et al. (2015). Is iron treatment beneficial in, iron-deficient but non-anaemic (IDNA) endurance athletes? A systematic review and meta-analysis. British Journal of Sports Medicine, 49(21), 1389–1397. doi:10.1136/bjsports-2014-093833