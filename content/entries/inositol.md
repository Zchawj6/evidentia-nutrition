...
tags: ["inositol", "myo-inositol", "d-chiro-inositol", "PCOS", "gestational-diabetes", "insulin-resistance", "fertility", "womens-health"]
aliases: ["myo-inositol", "myoinositol", "d-chiro-inositol", "DCI", "inositol supplement", "inositol PCOS", "inositol fertility"]
primaryRating: "Moderate"
primaryOutcome: "Prevention of gestational diabetes mellitus in high-risk women"
outcomeType: "clinical"
numberOfRCTs: 8
totalParticipantN: 1795
independentReplication: true
industryFundedDominance: false
riskOfBiasSummary: "Some to high concerns; variable blinding, several trials conducted in single country (Italy), performance bias prevalent"
consistencyFlag: "Mostly Consistent"
surrogateOnly: false
formSpecificEvidence: true
formStudied: "Myo-inositol (MI) is the primary studied form; D-chiro-inositol (DCI) has a distinct evidence profile and the two are not interchangeable"
additionalOutcomes:
  - outcome: "Metabolic and hormonal markers in PCOS"
    rating: "Moderate"
    outcomeType: "biomarker"
    numberOfRCTs: 9
    totalParticipantN: 496
    riskOfBiasSummary: "Some to high concerns; small samples, heterogeneous populations, variable blinding"
    consistencyFlag: "Mixed"
  - outcome: "Ovulation and menstrual regularity in PCOS"
    rating: "Emerging"
    outcomeType: "clinical"
    numberOfRCTs: 5
    totalParticipantN: 320
    riskOfBiasSummary: "High concerns; small samples, inconsistent diagnostic criteria, limited placebo-controlled data"
    consistencyFlag: "Mixed"
  - outcome: "Fertility outcomes in PCOS (pregnancy rate, live birth rate)"
    rating: "Insufficient"
    outcomeType: "clinical"
    numberOfRCTs: 4
    totalParticipantN: 280
    riskOfBiasSummary: "High concerns; small samples, co-interventions, outdated comparator treatments"
...
populationNotes: "Evidence is concentrated almost entirely in women of reproductive age with PCOS or at high risk for gestational diabetes. Evidence in men, healthy women without insulin resistance, or older populations is very limited."
safetyFlag: false
safetyNotes: "Generally well tolerated at doses up to 4g myo-inositol per day. Main adverse effects are mild gastrointestinal symptoms. High doses of D-chiro-inositol may impair oocyte quality. Considered safe in pregnancy at studied doses though long-term data is limited."
...
secondaryCategories: ["metabolic-health", "fertility", "pregnancy"]
relatedEntries: ["folate", "vitamin-d", "iron", "berberine"]
cardDescription: "Evidence is strongest for preventing gestational diabetes in high-risk women. PCOS metabolic benefits are real but more limited than commercial messaging implies. Fertility claims extend well beyond what placebo-controlled trials support. Form distinction between myo-inositol and D-chiro-inositol is clinically important."
---
...
The GDM prevention evidence is the most compelling in the inositol literature. A 2023 systematic review and meta-analysis by Greff et al. (Nutrients, 2023; 8 RCTs, n = 1,795) found that inositol supplementation reduced GDM incidence by roughly half compared to placebo (RR = 0.42, 95% CI 0.26 to 0.67). An earlier meta-analysis by Wei et al. (Nutrients, 2022; 7 RCTs, n = 1,321) found a similar direction of effect (RR = 0.30, 95% CI 0.18 to 0.49), with significant reductions in fasting and post-load glucose across all OGTT time points. A meta-analysis focused specifically on overweight and obese women (Santangelo et al., 2022; 4 RCTs) found consistent GDM risk reduction in this high-risk subgroup (OR 0.32, 95% CI 0.21 to 0.48; I2 = 0%).

The relative risk reductions are large, but the clinical significance depends on baseline risk. In the trial populations, GDM incidence in control groups ranged from approximately 15% to 30% in high-risk women, which means the absolute risk reductions are meaningful, in the region of 8 to 15 percentage points, rather than a reduction from a very low baseline. This context matters for interpreting how clinically impactful the intervention is in practice.

The standard dose across positive trials is 4g myo-inositol daily, typically combined with 400mcg folic acid, begun in the first trimester. Most trials have been conducted in Italian populations, which raises questions about generalisability, and the generally consistent direction of effects should be read against that concentration. Risk of bias is rated at some to high concerns across the body of work, primarily due to blinding limitations and potential performance bias. A Cochrane review on antenatal myo-inositol supplementation (2023) noted that while results were promising, the evidence was not yet sufficient to recommend routine supplementation pending further high-quality trials.

The absolute risk reductions described above, in the region of 8 to 15 percentage points, reflect trial populations where baseline GDM risk was elevated. In lower-risk populations, absolute benefit would be smaller, and the intervention is not established in women without identifiable risk factors.

**Evidence rating basis:** 8 RCTs, combined N approximately 1,800, consistent direction, moderate effect sizes, replicated across meta-analyses, some concerns on risk of bias, geographical concentration a limitation. Rated Moderate rather than Strong due to these methodological concerns and the lack of a definitive large-scale multicentre trial.

### PCOS metabolic markers

The most methodologically sound summary of PCOS evidence is the systematic review and meta-analysis by Fitz et al. (Journal of Clinical Endocrinology and Metabolism, 2024), produced to inform the 2023 international PCOS guidelines. This review included 30 trials (n = 2,230) and found evidence suggesting benefit for some metabolic measures, particularly insulin resistance biomarkers, but concluded overall that the evidence is limited and inconclusive across the full range of PCOS outcomes assessed.

An earlier meta-analysis by Unfer et al. (Endocrine Reviews, 2017; 9 RCTs, n = 496) found significant reductions in fasting insulin (SMD = -1.02, 95% CI -1.79 to -0.25, p = 0.009) and HOMA-IR (SMD = -0.585, 95% CI -1.14 to -0.025, p = 0.041) following myo-inositol supplementation versus controls. A trend toward reduced testosterone did not reach statistical significance (SMD = -0.49, p = 0.099). SHBG increases were only significant in trials of at least 24 weeks duration, suggesting that shorter interventions may underestimate the hormonal effects.

**Interpretation:** The insulin resistance biomarker evidence is the most consistently observed signal in the PCOS literature and provides a plausible mechanism for other downstream effects. The reported SMDs are large, a value of -1.02 for fasting insulin would be considered a large effect, but effect sizes from small, heterogeneous trials are prone to inflation, and these figures should be interpreted with that caveat in mind. Biomarker improvements do not automatically translate to clinical benefit, and the clinical relevance of these changes in the absence of confirmed improvements in endpoints such as live birth rate or sustained menstrual regularity remains uncertain.

### Ovulation and menstrual regularity in PCOS

Several RCTs have reported improvements in ovulation rate and menstrual cycle regularity in women with PCOS following myo-inositol supplementation. Some non-placebo-controlled studies have also reported positive signals, but these cannot support causal conclusions and are not the basis for the evidence rating here.

Placebo-controlled RCT evidence for ovulation and menstrual regularity is present but smaller in size and less consistent. Some trials show meaningful improvements in ovulation rate; others do not, and the populations vary substantially in terms of PCOS phenotype, BMI, and degree of insulin resistance.

**Interpretation:** The ovulation and menstrual regularity evidence is directionally promising but not sufficiently replicated in well-controlled trials to support confident claims in all PCOS populations.

### Fertility outcomes in PCOS

This is where the gap between commercial messaging and the evidence base is most pronounced. Myo-inositol has been studied as an adjunct to fertility treatments including clomiphene citrate, gonadotrophins, and IVF, but most of these trials were conducted against a background of ovulation induction agents that are no longer considered gold standard, particularly clomiphene citrate. Current PCOS guidelines favour letrozole as first-line ovulation induction, and most inositol fertility trials have not been conducted alongside letrozole-based protocols.

The 2024 Fitz et al. meta-analysis, informing the 2023 international PCOS guidelines, concluded that myo-inositol supplementation is not recommended in subfertile individuals with PCOS based on the available placebo-controlled evidence. A 2025 commentary in Reproductive BioMedicine Online (Palomba et al.) reached the same conclusion, noting that the clinical utility of myo-inositol in modern fertility practice remains uncertain given the lack of robust RCTs with current gold-standard comparators.

**Evidence rating basis:** Insufficient for fertility as a primary endpoint. The mechanistic rationale and some trial signals exist, but placebo-controlled evidence for live birth rate or clinical pregnancy rate in PCOS does not currently support clinical recommendation.

## How to interpret the DCI evidence

D-chiro-inositol has a distinct and partially counterintuitive evidence profile. While it participates in insulin signalling, excessive DCI in follicular fluid, as opposed to the normal 100:1 MI:DCI ratio, is associated with impaired oocyte quality. This is proposed to be due to epimerase overactivation in PCOS ovarian tissue, converting excess myo-inositol to DCI and creating a local deficit of the form needed for normal oocyte development. Supplementing high-dose DCI may worsen this imbalance in ovarian tissue while improving systemic insulin resistance, producing a divergence between metabolic and reproductive effects. Products using a 40:1 MI:DCI ratio attempt to reflect a more physiological approach, though the optimal formulation for different outcomes has not been definitively established.

## Funding and independence

The myo-inositol PCOS and GDM literature has a notable geographical concentration in Italy, where several research groups have been closely associated with the development of inositol products. The Unfer et al. (2017) meta-analysis, one of the most cited in this space, had two authors employed by Lo.Li. Pharma (an inositol product manufacturer) and a third who received consulting compensation from the same company. While this does not invalidate the findings, it warrants acknowledgement when interpreting effect sizes and conclusions, as independent replication from geographically diverse and commercially unaffiliated groups is more limited than the quantity of publications might suggest.

## Key references

Fitz V et al. (2024). Inositol for polycystic ovary syndrome: a systematic review and meta-analysis to inform the 2023 update of the international evidence-based PCOS guidelines. Journal of Clinical Endocrinology and Metabolism, 109(6), 1630-1655. doi:10.1210/clinem/dgad762

Greff D et al. (2023). Myoinositols prevent gestational diabetes mellitus and related complications: a systematic review and meta-analysis of randomized controlled trials. Nutrients, 15(19), 4224. doi:10.3390/nu15194224

Wei J et al. (2022). Inositol nutritional supplementation for the prevention of gestational diabetes mellitus: a systematic review and meta-analysis of randomized controlled trials. Nutrients, 14(14), 2831. doi:10.3390/nu14142831

Unfer V et al. (2017). Myo-inositol effects in women with PCOS: a meta-analysis of randomized controlled trials. Endocrine Connections, 6(8), 647-658. doi:10.1530/ec-17-0243. Note: two authors were employees of Lo.Li. Pharma and one received consulting compensation from the same company at time of publication.

Teede HJ et al. (2023). International evidence-based guideline for the assessment and management of polycystic ovary syndrome. Medical Journal of Australia, 219(7), 393-394. doi:10.5694/mja2.51684

Palomba S et al. (2025). Myo-inositol in reproductive management of women with PCOS: holy grail for medical practice or demon for scientific evidence? Reproductive BioMedicine Online. doi:10.1016/j.rbmo.2025.104476