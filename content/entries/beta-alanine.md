...
secondaryCategories: ["sports-performance"]
...
cardDescription: "A non-essential amino acid that raises muscle carnosine and improves high-intensity exercise performance in efforts lasting one to four minutes. Evidence is specific to exercise context and dose; general wellness claims are not supported."
tags: ["carnosine", "buffer", "exercise performance", "paresthesia", "musculoskeletal"]
---
...
### Muscle carnosine response

Beta-alanine's primary effect — raising muscle carnosine — is one of the more robustly demonstrated biomarker responses in sports nutrition. A systematic review and Bayesian meta-analysis (Hobson et al., updated in the carnosine response literature) found that supplementation at 3.2 to 6.4 g per day for 4 to 24 weeks consistently increases carnosine, with reported increases ranging from around 40% at four weeks to 80% at ten weeks using 4 to 6 g per day. The ISSN position stand notes carnosine increases of up to 64% after four weeks and up to 80% after ten weeks at these doses. Muscle carnosine is relatively stable in the absence of supplementation, and response rates are high; a Bayesian individual data analysis estimated that 99.3% of participants respond to supplementation. Neither sex nor baseline carnosine level appear to significantly influence the magnitude of response in meta-regression. Only an estimated 3 to 6% of ingested beta-alanine is incorporated into muscle carnosine, with the remainder metabolised via other pathways; this explains why high cumulative doses are required to achieve meaningful carnosine elevation.

Evidence rating: Strong (Validated Surrogate) — muscle carnosine reliably increases with supplementation; dose and duration dependent.

### Exercise performance

The performance evidence in high-intensity exercise is the central claim for beta-alanine and is supported by multiple meta-analyses. A foundational 2012 meta-analysis (Hobson et al., Amino Acids) of 15 trials found a small but significant overall effect on exercise performance. The effect was most pronounced in exercise bouts lasting 60 to 240 seconds (effect size 0.374), with limited support for shorter or longer durations. A 2017 systematic review and meta-analysis (Saunders et al., British Journal of Sports Medicine) examined 40 studies across 65 exercise protocols involving 1461 participants and confirmed benefits concentrated in the 1 to 4 minute window. A 2024 systematic review and meta-analysis (Georgiou et al., International Journal of Sport Nutrition and Exercise Metabolism) of 18 RCTs in trained young men found that 14 of 18 studies showed benefit on maximal intensity exercise, though effect sizes varied and four studies found neutral or small detrimental effects. For strength and power outcomes, the evidence is inconsistent: some trials at approximately 6.4 g per day report improvements in 1RM and related metrics, but others using similar doses show no benefit over placebo — particularly when buffering is not the primary limiting factor in the exercise task.

Evidence rating: Moderate (Clinical) — performance evidence specific to high-intensity exercise of 1 to 4 minutes; inconsistent outside this window.

### Older adults

A 2023 double-blind RCT (Ostfeld et al., Nutrients, n=100, aged 60 to 80) examined 10 weeks of beta-alanine at 2.4 g per day against placebo. No significant overall group difference was found for Montreal Cognitive Assessment scores. However, in the sub-group whose baseline cognitive scores were at or below normal threshold, significant improvements were seen at midpoint and endpoint. Improvements in geriatric depression scores were also observed. Physical function did not significantly improve. This is a single trial funded with involvement from a supplement manufacturer and the findings require independent replication before any clinical interpretation. The ISSN position stand separately notes that beta-alanine attenuates neuromuscular fatigue in older subjects across the exercise literature, which has a more established basis than the cognitive findings.

Evidence rating: Emerging (Clinical) — single RCT for cognitive outcomes; neuromuscular fatigue attenuation in older adults has moderate support.

### Dose, timing, and formulation

The ISSN recommends 4 to 6 g per day in divided doses for at least 2 to 4 weeks to achieve meaningful carnosine elevation and performance benefit. Doses should be split into servings of 1.6 g or less to manage paraesthesia. Sustained-release formulations allow larger single doses without significant tingling. Carnosine elevation continues to accrue with longer supplementation periods, and muscle carnosine declines slowly after cessation — washout takes several weeks. The dose-response relationship for performance is not as clearly established as for carnosine elevation, and higher doses do not uniformly produce greater performance benefit.

### Vegetarian and vegan populations

Muscle carnosine is obtained partly through dietary carnosine from meat and fish, and partly through endogenous synthesis from beta-alanine. People who avoid animal products have lower baseline muscle carnosine. Research confirms lower carnosine concentrations in vegetarians compared to omnivores. This suggests greater headroom for carnosine elevation through supplementation, but whether this produces a proportionally greater performance benefit in exercise contexts has not been systematically established.

---

### References

1. Trexler ET, Smith-Ryan AE, Stout JR, et al. International society of sports nutrition position stand: Beta-Alanine. J Int Soc Sports Nutr. 2015;12:30. doi:10.1186/s12970-015-0090-y. PMID: 26175657.

2. Hobson RM, Saunders B, Ball G, Harris RC, Sale C. Effects of β-alanine supplementation on exercise performance: a meta-analysis. Amino Acids. 2012;43(1):25-37. doi:10.1007/s00726-011-1200-z. PMC3374095.

3. Saunders B, Elliott-Sale K, Artioli GG, et al. β-alanine supplementation to improve exercise capacity and performance: a systematic review and meta-analysis. Br J Sports Med. 2017;51(8):658-669. doi:10.1136/bjsports-2016-096396. PMID: 27797728.

4. Georgiou GD, Antoniou K, Antoniou S, et al. Effect of Beta-Alanine Supplementation on Maximal Intensity Exercise in Trained Young Male Individuals: A Systematic Review and Meta-Analysis. Int J Sport Nutr Exerc Metab. 2024;34(6):397-410. doi:10.1123/ijsnem.2024-0027. PMID: 39032921.

5. Hobson RM, Harris RC, Martin D, et al. The Muscle Carnosine Response to Beta-Alanine Supplementation: A Systematic Review With Bayesian Individual and Aggregate Data E-Max Model and Meta-Analysis. Front Physiol. 2020;11:913. doi:10.3389/fphys.2020.00913. PMC7456894.

6. Ostfeld I, Ben-Zeev T, Zamir A, et al. Role of β-Alanine Supplementation on Cognitive Function, Mood, and Physical Function in Older Adults; Double-Blind Randomized Controlled Study. Nutrients. 2023;15(4):923. doi:10.3390/nu15040923. PMC9960300.

7. Harris RC, Tallon MJ, Dunnett M, et al. The absorption of orally supplied beta-alanine and its effect on muscle carnosine synthesis in human vastus lateralis. Amino Acids. 2006;30(3):279-289. doi:10.1007/s00726-006-0299-9. PMID: 16554972.

8. Oliveira EP, Artioli GG, Burini RC. Safety of beta-alanine supplementation in humans: a narrative review. Sport Sciences for Health. 2023. doi:10.1007/s11332-023-01102-1.
