...
tags: ["folate", "folic-acid", "methylfolate", "5-mthf", "mthfr", "methylation", "b9", "pregnancy", "homocysteine", "neural-tube-defects"]
aliases: ["folate", "folic acid", "methylfolate", "5-mthf", "l-methylfolate", "vitamin b9", "mthfr", "folate deficiency", "folic acid supplement", "methylation"]
primaryRating: "Strong"
primaryOutcome: "Prevention of neural tube defects in the periconceptional period"
outcomeType: "clinical"
numberOfRCTs: 4
totalParticipantN: 7000
riskOfBiasSummary: "Low to some concerns; MRC Vitamin Study is a landmark high-quality RCT; subsequent trials are smaller"
consistencyFlag: "Consistent"
ratingJustification: "Strong rating reflects a landmark RCT with a large and clinically important effect size, consistent replication in subsequent trials, and widespread adoption in public health policy across multiple countries"
surrogateOnly: false
formSpecificEvidence: true
formStudied: "Folic acid (prevention trials); methylfolate (MTHFR populations, limited comparative trial data)"
additionalOutcomes:
  - outcome: "Deficiency correction"
    rating: "Strong"
    outcomeType: "clinical"
    numberOfRCTs: 8
    totalParticipantN: 1400
    riskOfBiasSummary: "Low to some concerns"
    consistencyFlag: "Consistent"
  - outcome: "Homocysteine reduction in deficient individuals"
    rating: "Strong"
    outcomeType: "exploratory-biomarker"
    numberOfRCTs: 10
    totalParticipantN: 1800
    riskOfBiasSummary: "Low to some concerns"
    consistencyFlag: "Consistent"
    ratingNote: "Strong biomarker effect. Clinical translation to cardiovascular outcomes not demonstrated in large trials. See In Depth section."
  - outcome: "Cognitive function in folate-deficient older adults"
    rating: "Moderate"
    outcomeType: "clinical"
    numberOfRCTs: 4
    totalParticipantN: 620
    riskOfBiasSummary: "Some concerns; small trials, heterogeneous populations and outcome measures"
    consistencyFlag: "Mixed"
  - outcome: "Depression symptoms as adjunct treatment"
    rating: "Emerging"
    outcomeType: "clinical"
    numberOfRCTs: 4
    totalParticipantN: 480
    riskOfBiasSummary: "High concerns; small samples, variable designs, heterogeneous populations"
    consistencyFlag: "Mixed"
  - outcome: "Cardiovascular disease prevention"
    rating: "Insufficient"
    outcomeType: "clinical"
    numberOfRCTs: 6
    totalParticipantN: 39000
    riskOfBiasSummary: "Low risk of bias; large well-powered trials with consistent null findings"
    consistencyFlag: "Consistent"
individualisationRelevance: "Very high"
bloodTestingRelevant: true
geneticVariationRelevant: true
populationSpecific: true
populationNotes: "Neural tube defect prevention evidence applies specifically to women planning pregnancy or in the first 12 weeks of pregnancy. MTHFR C677T polymorphism affects folate metabolism biochemically in a meaningful proportion of the population, though the clinical decision-making implications for routine supplementation are not yet established by major guidelines. Older adults with low folate status represent a distinct risk group for cognitive and haematologic consequences."
safetyFlag: true
safetyNotes: "High-dose folic acid can correct the haematologic manifestations of B12 deficiency while neurological damage continues to progress undetected. This is the most clinically important safety consideration for folate supplementation. The upper tolerable intake for folic acid from supplements is 1,000 mcg per day for adults. Unmetabolised folic acid in circulation at high supplemental doses is a subject of ongoing research and the long-term implications are not yet fully established. The B12-masking risk with methylfolate may be lower or less well characterised than with folic acid, though it is not entirely absent given that any active folate can correct megaloblastic anaemia."
...
relatedEntries: ["vitamin-b12", "magnesium", "vitamin-d", "iron"]
cardDescription: "Strong evidence for neural tube defect prevention in the periconceptional period. Form choice between folic acid and methylfolate is relevant for individuals with MTHFR C677T polymorphism on mechanistic grounds, though clinical outcome evidence for superiority is limited. Routine MTHFR genotyping is not recommended by major clinical guidelines."
---
...
The MRC Vitamin Study Research Group (1991, *Lancet*; RCT, n = 1,817, women with previous NTD-affected pregnancy, 4 mg folic acid versus control) found a 72 per cent reduction in NTD recurrence (RR 0.28, 95% CI 0.12 to 0.71). This remains one of the largest effect sizes in nutritional supplementation trials and established the periconceptional folic acid recommendation.

Czeizel AE and Dudas I (1992, *NEJM*; RCT, n = 4,753, women without prior NTD-affected pregnancy, 0.8 mg folic acid versus trace element supplement) found a significant reduction in first NTD occurrence in the folic acid group with no cases versus 6 in control.

Subsequent observational data from food fortification programmes, notably in the United States after mandatory folic acid fortification of grain products in 1998, showed population-level reductions in NTD prevalence consistent with the trial evidence.

**Evidence rating basis:** Two well-designed RCTs with large effect sizes, consistent replication in observational data from national fortification programmes, and widespread adoption in clinical and public health guidelines. Strong rating is justified despite the relatively small number of RCTs by the magnitude and consistency of effect and the corroborating population-level evidence.

### MTHFR and methylfolate

The MTHFR C677T polymorphism reduces MTHFR enzyme activity by approximately 35 per cent in heterozygotes (CT genotype) and approximately 70 per cent in homozygotes (TT genotype) compared to the CC genotype. This impairs the conversion of 5,10-methylenetetrahydrofolate to 5-MTHF, the form needed for homocysteine remethylation and for cellular folate function.

TT homozygotes show higher plasma homocysteine and lower red cell folate at equivalent dietary intakes compared to CC individuals, particularly when folate status is marginal. This population-level finding supports the biological plausibility of preferring methylfolate in TT individuals.

However, clinical trial evidence directly comparing methylfolate to folic acid on patient-important outcomes specifically in MTHFR TT individuals is limited. Major clinical guidelines do not recommend routine MTHFR genotyping for supplementation decisions. The mechanistic case is strong; the outcomes evidence is not yet sufficient to establish this as a clear clinical recommendation.

Gilbody S et al. (2007, *American Journal of Epidemiology*; meta-analysis) found that the MTHFR C677T TT genotype was associated with elevated depression risk, which has generated interest in methylfolate supplementation for depression in this population, but direct interventional evidence remains limited.

### Homocysteine as a biomarker outcome

Folate is the primary determinant of plasma homocysteine. Supplementation in deficient and borderline-deficient individuals reliably lowers homocysteine. This biochemical effect is well-characterised and consistent.

The clinical translation of homocysteine reduction to cardiovascular outcomes has not been demonstrated. The HOPE-2 trial (Lonn et al., 2006, *NEJM*; n = 5,522, high cardiovascular risk adults, mean follow-up 5 years) found no significant reduction in major cardiovascular events despite a 25 per cent reduction in homocysteine. Multiple subsequent meta-analyses have confirmed this null relationship.

**Interpretation:** Homocysteine reduction is an exploratory biomarker effect for folate supplementation. It cannot be used as evidence of cardiovascular benefit.

### Unmetabolised folic acid

Following high-dose folic acid supplementation, unmetabolised folic acid (UMFA) appears in circulation. This occurs because the conversion pathway has limited capacity and is saturated at higher doses. The biological significance of UMFA is an active area of research. Some studies have raised concerns about potential effects on natural killer cell function and other immune parameters, but the clinical significance and dose-response relationships are not yet established. Current evidence does not support harm at doses within the recommended upper tolerable intake, but this is a rationale for not routinely exceeding 1,000 mcg folic acid daily without clinical indication.

## How to interpret this evidence

The folate evidence base spans two quite different evidence contexts that should not be conflated.

The neural tube defect prevention evidence is one of the strongest in nutritional medicine: large effect sizes, direct trial evidence, and consistent population-level corroboration. This is a context where the intervention is clearly indicated and the evidence is not in serious dispute.

The homocysteine, cardiovascular, cognitive, and depression evidence sits in a much more uncertain space. The biomarker effects are real; the clinical translation is either null (cardiovascular) or insufficiently established (cognitive, depression). Supplementation in these contexts cannot be justified by homocysteine reduction alone.

The MTHFR and methylfolate discussion sits between these two contexts: mechanistically well-supported, clinically plausible, but not yet definitively established by large outcome trials. The appropriate epistemic posture is that methylfolate is a reasonable choice for individuals with confirmed MTHFR TT genotype, not that it is proven superior in outcome terms.
...
Lonn E et al. (2006). Homocysteine lowering with folic acid and B vitamins in vascular disease. *NEJM*, 354(15), 1567–1577. doi:10.1056/NEJMoa060900

Gilbody S et al. (2007). Methylenetetrahydrofolate reductase (MTHFR) genetic polymorphisms and psychiatric disorders: a HuGE review. *American Journal of Epidemiology*, 165(1), 1–13. doi:10.1093/aje/kwj347

Obeid R et al. (2022). Folate status and health: challenges and opportunities. *Journal of Nutritional Science*, 11, e72. doi:10.1017/jns.2022.72
