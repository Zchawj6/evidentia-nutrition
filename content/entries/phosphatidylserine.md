...
tags: [cognitive-health, brain-health, memory, stress, ageing, performance]
aliases: [PS, phosphatidyl serine]
primaryRating: Moderate
primaryOutcome: Memory outcomes in older adults with cognitive decline or age-associated memory impairment
outcomeType: Clinical
numberOfRCTs: 5
totalParticipantN: 783 (RCT participants only; the 2022 meta-analysis also included 178 participants across four pre-post studies, not counted here)
riskOfBiasSummary: Mixed; four of five RCTs in the key meta-analysis used bovine cortex-derived PS, which is no longer commercially available; most trials were short (6 weeks to 6 months) and used heterogeneous outcome measures
consistencyFlag: Partially consistent; positive signal across older trials but soy-derived PS trials show weaker and more variable effects
surrogateOnly: false
formSpecificEvidence: true
formStudied: Soy-derived phosphatidylserine (S-PS); historically bovine cortex-derived (BC-PS), now largely unavailable
additionalOutcomes:
  - outcome: Cortisol attenuation with exercise stress
    rating: Emerging
    outcomeType: Biomarker
    numberOfRCTs: 3
    totalParticipantN: 29
    riskOfBiasSummary: Very small trials with male-only samples; findings inconsistent across dose levels
    consistencyFlag: Inconsistent
  - outcome: Cognitive function in healthy younger adults
    rating: Insufficient
    outcomeType: Clinical
    numberOfRCTs: 3
    totalParticipantN: 196
    riskOfBiasSummary: Mostly industry-funded; mixed and generally modest effects
    consistencyFlag: Inconsistent
individualisationRelevance: true
...
relatedEntries: [citicoline, lions-mane, omega-3, 5-htp]
cardDescription: Evidence supports modest memory benefits in older adults with cognitive decline, primarily from trials using bovine-derived PS no longer on the market. Soy-derived versions show weaker effects. Cortisol and athletic performance claims rest on very small studies.
---
...
## Cognitive function: older adults with decline

The 2022 meta-analysis by Kang et al. (Korean Journal of Food Science and Technology) is the most comprehensive quantitative synthesis to date. Nine studies were included: five RCTs (n=783) and four pre-post studies (n=178). Doses ranged from 100 to 300 mg per day and trial durations from six weeks to six months. The meta-analysis found a positive effect on memory measures, but the heterogeneity of outcome instruments across trials (Buschke Selective Reminding Test, Rey Auditory Verbal Learning Test, Clinical Global Impression, activities of daily living scales) limits interpretability. Four of the five RCTs used bovine cortex PS, not currently available.

The Cenacchi et al. (1993, Aging Clinical and Experimental Research) trial remains the largest and most cited study in this domain. 494 elderly patients (aged 65 to 93) with moderate to severe cognitive decline, recruited across 23 geriatric units in northeastern Italy, were randomised to 300 mg per day BC-PS or placebo for six months. Statistically significant improvements were observed in the PS group on both the Plutchik Geriatric Rating Scale (behavioural outcomes) and the Buschke Selective Reminding Test (memory). 69 patients dropped out before completion. No serious adverse effects were attributed to treatment.

The Engel et al. (1992, European Neuropsychopharmacology) double-blind crossover trial in patients with early Alzheimer's-type dementia found no clinically meaningful benefit from BC-PS. Earlier Alzheimer's trials (Crook et al., 1992; Delwaide et al., 1986) reported marginal improvements in mild to moderate disease, with effects diminishing or absent in more severe cases.

## Cognitive function: soy-derived PS

Jorissen et al. (2001) conducted the most rigorous soy-only RCT, enrolling older adults with memory complaints. S-PS at 300 or 600 mg per day for 12 weeks showed no advantage over placebo. Kato-Kataoka et al. (2010) found comparable improvement in both active and placebo groups, raising the possibility of a strong expectancy effect. Richter et al. (2013, Clinical Interventions in Aging) reported benefits from 100 mg per day S-PS over 15 weeks in an elderly population with subjective memory complaints, but the study design was partly open-label and the sample small.

## Cortisol and HPA axis modulation

Monteleone et al. (1992, European Journal of Clinical Pharmacology) examined nine healthy men given 800 mg per day BC-PS or placebo for 10 days in a placebo-controlled design. Cortisol and ACTH responses to bicycle ergometer exercise were reported as significantly blunted (p=0.003 and p=0.03 respectively) without affecting growth hormone or prolactin. Starks et al. (2008, Journal of the International Society of Sports Nutrition) used a crossover design in 10 healthy males, finding that 600 mg per day S-PS for 10 days reduced peak cortisol concentrations by approximately 39% compared to placebo during moderate intensity cycling. Hellhammer et al. (2004, Stress) used a phosphatidic acid and PS complex rather than PS alone, and found that the 400 mg dose (but not 600 or 800 mg) attenuated cortisol and ACTH responses to the Trier Social Stress Test in 80 subjects. The non-linear dose response and the formulation difference (complex vs PS alone) mean this cannot be straightforwardly applied to PS supplementation. A 2010 crossover trial by Bloms et al. (JISSN) in resistance-trained males using 400 mg S-PS for 14 days found no effect on cortisol or testosterone, though cognitive function before exercise was modestly improved.

## Key references

Kang EY, Cui F, Kim HK, Go GW. Effect of phosphatidylserine on cognitive function in the elderly: a systematic review and meta-analysis. Korean Journal of Food Science and Technology. 2022.

Cenacchi T, Bertoldin T, Farina C, Fiori MG, Crepaldi G. Cognitive decline in the elderly: a double-blind, placebo-controlled multicenter study on efficacy of phosphatidylserine administration. Aging Clinical and Experimental Research. 1993;5(2):123–133.

Engel RR, Satzger W, Günther W, et al. Double-blind cross-over study of phosphatidylserine vs. placebo in patients with early dementia of the Alzheimer type. European Neuropsychopharmacology. 1992;2(2):149–155.

Jorissen BL, Brouns F, Van Boxtel MP, et al. The influence of soy-derived phosphatidylserine on cognition in age-associated memory impairment. Nutritional Neuroscience. 2001;4(2):121–134.
...
Monteleone P, Maj M, Beinat L, Natale M, Kemali D. Blunting by chronic phosphatidylserine administration of the stress-induced activation of the hypothalamo-pituitary-adrenal axis in healthy men. European Journal of Clinical Pharmacology. 1992;42(4):385–388.
...
Duan H, Xu N, Yang T, Wang M, Zhang C, Zhao J, Li Z, Chen Y, Yan J, Zhang M, Li W, Yue Z, Ma F, He R, Huang G. Effects of a food supplement containing phosphatidylserine on cognitive function in Chinese older adults with mild cognitive impairment: a randomized double-blind, placebo-controlled trial. Journal of Affective Disorders. 2025 Jan 15;369:35–42. doi:10.1016/j.jad.2024.09.131.

Richter Y, Herzog Y, Hayun R, Mirelman D, Zchut S, Yerushalmi M, Milgram NW, Harvey BH, Vakhapova V. A randomized, double-blind, placebo-controlled, parallel study investigating the efficacy of a whole coffee cherry extract and phosphatidylserine formulation on cognitive performance of healthy adults with self-perceived memory problems. Neurology and Therapy. 2023;12(3):765–786.
