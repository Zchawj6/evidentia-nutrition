---
title: "Seed oils: what does the evidence actually show?"
...
The mechanistic case against seed oils rests on plausible biology that has not been confirmed in human outcome trials. The cardiovascular trial evidence mostly favours modest benefit from replacing saturated fat with polyunsaturated fat, though two discordant trials mean this is not unequivocally established. The oxidation concern at high cooking temperatures is real in laboratory conditions but its clinical significance under normal cooking use is not established. Not all seed oils are equivalent: the reasonable concerns apply most directly to high-linoleic acid oils at high intake, not to lower-LA alternatives such as rapeseed. The replacement nutrient matters: benefit depends on substituting saturated fat with PUFA, not with refined carbohydrate. The honest position is that seed oils are unlikely to be the dietary villain they are portrayed as online, but the evidence base has meaningful gaps that justify continued research rather than confident dismissal in either direction.
</div>
...
<iframe src="/interactive/seed-oils-evidence-map.html" width="100%" height="720" style="border:none;border-radius:10px;display:block;margin:24px 0;" title="Seed oils: mapping the mechanistic claims against the human evidence"></iframe>
...
*For related evidence, see the [Omega-3](/library/omega-3) entry in the Evidentia library.*
