...
const PLACEHOLDER_ENTRIES = [
  { slug: 'ashwagandha', title: 'Ashwagandha', category: 'adaptogen', secondaryCategories: ['womens-health', 'cognitive-health', 'longevity'], primaryRating: 'Moderate', cardDescription: 'Ashwagandha has the most consistent evidence base of the mainstream adaptogens, with reasonable trial quality for stress and anxiety outcomes. Evidence for other claimed benefits is thinner.' },
  { slug: 'berberine', title: 'Berberine', category: 'hormonal-metabolic', primaryRating: 'Moderate', cardDescription: "Berberine has a meaningful evidence base for glycaemic control in type 2 diabetes and insulin resistance, but the popular 'natural metformin' framing substantially overstates the evidence. Trial quality is limited, most data come from a single geographic context, long-term safety is not established, and evidence in healthy adults without metabolic indication is absent." },
  { slug: 'citicoline', title: 'Citicoline', category: 'cognitive-health', secondaryCategories: ['womens-health', 'longevity'], primaryRating: 'Moderate', cardDescription: 'Citicoline has a plausible mechanism and some positive trial data for cognitive outcomes, particularly in older adults with mild impairment. Evidence in healthy younger adults is less compelling.' },
  { slug: 'coq10', title: 'CoQ10 (Ubiquinone)', category: 'longevity', secondaryCategories: ['womens-health'], primaryRating: 'Moderate', cardDescription: 'CoQ10 has reasonable evidence for specific clinical populations, particularly individuals on statins and those with heart failure. Evidence for broad anti-ageing or energy benefits in healthy adults is not well supported.' },
  ...
  { slug: 'omega-3', title: 'Omega-3 fatty acids', category: 'macronutrient', secondaryCategories: ['womens-health', 'cognitive-health', 'longevity'], primaryRating: 'Moderate', cardDescription: 'Omega-3s have strong evidence for triglyceride reduction and specific cardiovascular populations, but the picture for general prevention is more complicated than popular belief suggests.' },
  ...
  { slug: 'vitamin-b12', title: 'Vitamin B12', category: 'micronutrient', primaryRating: 'Strong', cardDescription: 'Critical for neurological function and red blood cell formation. Deficiency risk is high in vegans, older adults, and those on metformin. Form and route of administration matter more than is commonly appreciated.' },
