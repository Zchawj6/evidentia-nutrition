...
const PLACEHOLDER_ENTRIES = [
  ...
  { slug: 'curcumin-phytosome', title: 'Curcumin (Enhanced Bioavailability Forms)', category: 'botanical', secondaryCategories: ['cognitive-health', 'longevity'], primaryRating: 'Moderate', cardDescription: 'Solving the bioavailability problem changes the evidence picture materially. Enhanced forms -- particularly curcumin phytosome -- have meaningful trial evidence for joint and inflammatory outcomes that standard extract does not.' },
]
