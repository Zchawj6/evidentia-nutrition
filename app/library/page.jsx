...
const PLACEHOLDER_ENTRIES = [
  ...
  { slug: 'creatine', title: 'Creatine', category: 'performance', primaryRating: 'Strong', cardDescription: 'One of the most robustly evidenced supplements in existence. The evidence base is strong for specific outcomes but the commercial narrative consistently outruns it.' slug: 'creatine', title: 'Creatine', category: 'performance', secondaryCategories: ['womens-health', 'cognitive-health', 'longevity'], primaryRating: 'Strong', cardDescription: '...'  },
