...
const PLACEHOLDER_ENTRIES = [
  ...
  { slug: 'astaxanthin', title: 'Astaxanthin', category: 'longevity', secondaryCategories: ['cognitive-health', 'womens-health'], primaryRating: 'Emerging', cardDescription: 'A marine carotenoid with the most developed human evidence base among antioxidant supplements for skin ageing and photoprotection. Nine RCTs support modest improvements in skin moisture, elasticity, and wrinkle measures. A smaller cognitive signal exists across four positive RCTs. The evidence is geographically concentrated, largely sponsor-linked, and not independently replicated at scale.' },
  { slug: 'bacopa', title: 'Bacopa Monnieri', category: 'Cognitive health', secondaryCategories: ['Mental health'], primaryRating: 'Moderate', cardDescription: 'Bacopa monnieri is an Ayurvedic herb with the most consistent evidence for improving delayed memory recall in healthy older adults. Trials are small and heterogeneous. Evidence in dementia is insufficient and no guidelines recommend its use.' },
  ...
  { slug: 'dhea', title: 'DHEA (Dehydroepiandrosterone)', category: 'Hormonal health', secondaryCategories: ['Bone health', 'Sexual health', 'Cognitive health'], primaryRating: 'Moderate', cardDescription: 'DHEA is a steroid hormone precursor that declines with age. Intravaginal DHEA has regulatory approval for menopausal dyspareunia. Evidence for oral supplementation is limited and inconsistent across most claimed outcomes.' },
  { slug: 'egcg', title: 'EGCG (Green Tea Extract)', category: 'metabolic-health', primaryRating: 'Emerging', cardDescription: 'The primary polyphenol in green tea, with the most marketing claims and one of the more significant supplement safety concerns. Small but consistent weight effects exist in pooled analysis; cancer prevention claims are not supported by RCT evidence; hepatotoxicity at high supplemental doses is well-characterised and has attracted regulatory attention.' },
  ...
  { slug: 'ginkgo-biloba', title: 'Ginkgo Biloba', category: 'Cognitive health', secondaryCategories: ['Cardiovascular health', 'Brain health'], primaryRating: 'Moderate', cardDescription: 'Ginkgo biloba is one of the most widely used cognitive supplements globally. Evidence supports modest symptomatic benefit in mild cognitive impairment and early dementia. It does not prevent cognitive decline in healthy older adults.' },
  { slug: 'glycine', title: 'Glycine', category: 'longevity', primaryRating: 'Emerging', cardDescription: 'The simplest amino acid, with a small and conflict-of-interest-affected sleep evidence base and growing interest in metabolic and longevity contexts. The GlyNAC combination trials are promising but do not establish glycine-specific effects. Independent replication across all outcome domains is absent.' },
  { slug: 'hmb', title: 'HMB (Beta-Hydroxy Beta-Methylbutyrate)', category: 'muscle-health', secondaryCategories: ['performance', 'healthy-ageing'], primaryRating: 'Moderate', cardDescription: 'HMB shows a modest, consistent signal for lean mass preservation in older adults and catabolic clinical populations. Evidence in trained younger adults is largely negative for body composition. The effect sizes are small and the field has a combination-product attribution problem that complicates conclusions.' },
  ...
  { slug: 'melatonin', title: 'Melatonin', category: 'sleep', secondaryCategories: ['healthy-ageing', 'womens-health'], primaryRating: 'Moderate', cardDescription: 'Melatonin has reasonable evidence for reducing sleep onset latency in circadian rhythm disruption and clinical populations. Effects in healthy adults with primary insomnia are more modest and inconsistent.' },
  ...
  { slug: 'nattokinase', title: 'Nattokinase', category: 'cardiovascular', primaryRating: 'Emerging', cardDescription: 'A fibrinolytic enzyme from fermented soybean with a well-characterised mechanism and modest blood pressure evidence across pooled RCTs. Clinical antithrombotic endpoint evidence is absent. Safety concerns around anticoagulant interactions are substantive and documented in case reports — this supplement has a higher clinical risk profile than most in the library.' },
  { slug: 'nicotinamide-riboside', title: 'Nicotinamide Riboside', category: 'longevity', primaryRating: 'Emerging', cardDescription: 'A vitamin B3 derivative that reliably raises blood NAD+ levels in humans. Despite a plausible mechanism and active research, clinical trials have not demonstrated consistent functional benefits, and an independent systematic review concludes the evidence for clinical effects remains weak.' },
  ...
  { slug: 'panax-ginseng', title: 'Panax Ginseng', category: 'adaptogen', primaryRating: 'Emerging', cardDescription: 'One of the most globally searched adaptogens, with a modest and inconsistent clinical evidence base across fatigue and cognition. The key interpretive challenge is that most meta-analyses pool across distinct ginseng species, making species-specific conclusions difficult. Evidence is more consistent in disease-affected populations than in healthy individuals.' },
  ...
  { slug: 'saffron', title: 'Saffron', category: 'mental-health', secondaryCategories: ['womens-health', 'sleep'], primaryRating: 'Moderate', cardDescription: 'A spice-derived extract with the most consistent human evidence for mood in the herbal supplement space. Multiple meta-analyses support efficacy in mild-to-moderate depression and non-inferiority to SSRIs, though most trials are small and geographically concentrated.' },
  ...
  { slug: 'shatavari', title: 'Shatavari', category: 'womens-health', primaryRating: 'Emerging', cardDescription: 'An Ayurvedic herb with emerging RCT evidence for perimenopausal symptom relief and postpartum lactation support. Phytoestrogenic activity requires caution in hormone-sensitive conditions.' },
  ...
  { slug: 'urolithin-a', title: 'Urolithin A', category: 'longevity', primaryRating: 'Emerging', cardDescription: 'A gut-derived postbiotic with early human evidence for muscle endurance and mitochondrial support in middle-aged and older adults. All pivotal trials are industry-sponsored and independent replication is lacking.' },
...
const PLACEHOLDER_ARTICLES = [
  { slug: 'berberine-vs-metformin', title: 'Berberine vs metformin: what does the evidence actually show?', type: 'article', cardDescription: 'Berberine and metformin show similar effects on glycaemic markers in short-term trials. But similar biomarker effects are not the same as a comparable evidence base. This article examines what the trials actually show.' },
  { slug: 'choline', title: 'Choline', category: 'micronutrient', secondaryCategories: ['womens-health', 'cognitive-health'], primaryRating: 'Emerging', cardDescription: 'Choline is an essential nutrient with its most defensible practical relevance in pregnancy, where adequate intake supports fetal development and small trials suggest favourable early neurocognitive outcomes. Observational evidence links lower maternal choline status with higher neural tube defect risk, but causality is not proven. Evidence for supplementation in healthy replete adults is limited and inconsistent. Free choline salts can raise TMAO, a plausible but unproven cardiovascular safety concern.' },
  { slug: 'creatine-and-women', title: 'Creatine and women: what does the evidence actually show?', type: 'article', cardDescription: 'Creatine has one of the strongest evidence bases in sports nutrition, but most of that research was done in men. The evidence in women is growing, biologically coherent, and more nuanced than the marketing on either side suggests.' },
  { slug: 'folate-vs-folic-acid', title: 'Folate vs folic acid: does the difference actually matter?', type: 'article', cardDescription: 'Folate and folic acid are not the same compound, and the distinction is metabolically meaningful for some people. Whether it changes what you should take depends on why you are supplementing and whether you have an MTHFR variant.' },
  { slug: 'iodine-plant-based-diets', title: 'Should you take iodine if you do not eat meat?', type: 'article', cardDescription: 'Iodine is largely invisible in nutrition conversations, yet deficiency is common on plant-based diets. This article examines the evidence for supplementation.' },
  { slug: 'reading-the-evidence-part-1', title: 'How research is graded and why it matters', type: 'article', cardDescription: 'Not all evidence is equal. Understanding how research is graded and what the hierarchy actually means is the foundation of reading supplement claims critically.' },
  { slug: 'reading-the-evidence-part-2', title: 'How to read a study critically', type: 'article', cardDescription: 'Knowing a study exists is not the same as knowing what it shows. This guide covers bias, blinding, effect size, and the questions to ask before trusting a result.' },
  { slug: 'reading-the-evidence-part-3', title: 'Surrogate markers and what they do not tell you', type: 'article', cardDescription: 'A biomarker improving is not the same as a clinical outcome improving. Understanding surrogate markers is essential to avoiding one of the most common errors in supplement research.' },
  { slug: 'reading-the-evidence-part-4', title: 'Why studies conflict and what it means', type: 'article', cardDescription: 'Conflicting studies are not evidence that nothing works. They are usually evidence of heterogeneity. This article explains why results vary and how to interpret disagreement.' },
  { slug: 'reading-the-evidence-part-5', title: 'How to draw calibrated conclusions from a mixed evidence base', type: 'article', cardDescription: 'Forest plots, publication bias, and I squared: how to synthesise a mixed literature and reach conclusions that are honest about uncertainty.' },
  { slug: 'vitamin-d-and-k2', title: 'Should you take vitamin D and K2 together?', type: 'article', cardDescription: 'The combination of vitamin D and K2 is widely marketed on the basis that K2 directs calcium where it should go. The rationale is biologically coherent. The direct clinical trial evidence for the combination is limited.' },
  ...
  { slug: 'omega-3-dosing', title: 'Omega-3 dosing: how much do you actually need?', type: 'article', cardDescription: 'The evidence for omega-3 is strong in specific contexts, but the question of how much to take is rarely answered clearly. This article examines what the dosing data actually supports.' },
